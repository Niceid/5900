...
#define rcsp_err_puts         ew_puts
#define rcsp_err_printf       ew_printf
#define rcsp_put_buf          put_buf
#define rcsp_db_puts          ew_puts
#define rcsp_db_printf        ew_printf
#define rcsp_tag_puts          ew_puts
#define rcsp_tag_printf        ew_printf
...
extern int user_eq_seg_gain[6+14][10];
extern int user_eq_global_gain[6+14];
