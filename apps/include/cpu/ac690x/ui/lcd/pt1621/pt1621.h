...
typedef struct{
	...
	lcd_flash_t	flash[_LCD_FLASH_LENGTH_];
		...
		uint8		lcm_disp_old[_LCD_SUPPORT_LEVEL_][_SUPPORT_LCM_1618_DRIVE_char_size];
		uint8		lcm_disp_now[_LCD_SUPPORT_LEVEL_][_SUPPORT_LCM_1618_DRIVE_char_size];
		uint8		disp_level_old;
#endif
}lcd_info_t;
