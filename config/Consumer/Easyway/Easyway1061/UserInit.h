...
#define __PRODUCT_INFO__							"easyway1061"
...
#define _AUDIO_USE_DECODER_		//	用解码内部处理音频
...
/*---------------------------------------------------
	调试选择
---------------------------------------------------*/
#if defined(_SUPPORT_DEBUG_)||defined(use_usb_as_uart)||defined(use_mic_as_uart)
...
---------------------------------------------------*/
#if   defined (TD_ADD_KB1069)
#define LCD_MAP_NAME					EASYWAY1061              //lcd5_8
//#define LCD_MAP_NAME					EASYWAY1061_led7pin     // 7pin led

#else
#define LCD_MAP_NAME					EasyWay_1		//EasyWay	//
#endif
...
/*---------------------------------------------------
	引脚选择
---------------------------------------------------*/
#if	defined  (TD_ADD_DAB1069)
#define PIN_MAP_NAME					dab1069
#elif defined   (	TD_ADD_KB1069)
#define PIN_MAP_NAME					kb1069
#else
#define PIN_MAP_NAME					kb1069//demo
#endif
/*---------------------------------------------------
	设置选择
---------------------------------------------------*/
...
#define SET_MUTE_WHEN_VOL_          //音量为0时,无声

#define _ENABLE_SYSPOW_LOW_        //低电平开机
