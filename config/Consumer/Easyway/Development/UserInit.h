...
#define __PRODUCT_INFO__							"Development"
#define __PRODUCT_EASYWAY_DEVELOPMENT__	




//#define TD_ADD_KB1069			1
//#define TD_ADD_DAB1069			1


#if	defined	(TD_ADD_DAB1069)
#define TD_ADD_RCLK_32_768K		1
#define	TD_ADD_USER_UART		1
#endif
...
#if    (!defined(TD_ADD_KB1069)) &&  (!defined(TD_ADD_DAB1069))
