...
#define __FIRM_INFO__								"EvbDemo"
#define __PRODUCT_INFO__							"EvbDemo"
...
#if defined(_SUPPORT_PB6PB7_)
#define _SUPPORT_TEST_BT_
#endif
...
/*---------------------------------------------------
	调试选择
---------------------------------------------------*/
#if defined(_SUPPORT_DEBUG_)||defined(use_usb_as_uart)||defined(use_mic_as_uart)||defined(_SUPPORT_PB6PB7_)
...
/*---------------------------------------------------
	特殊功能配置
----------------------------------------------------*/
//#define BT_PHONE_NUMBER             //使能来去电报号功能，默认报号一遍

//#define _DISABLE_CALL_RING_        //打出电话不要语音

#if defined(BT_PHONE_NUMBER)
#define _BT_SPECIAL_MUTE_          //修改在非蓝牙模式来电语音第一位报不出来
#endif
