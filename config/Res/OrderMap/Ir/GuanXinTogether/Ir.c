...
const ORDER_CFG ORDER_RADIO_IR[]=
{
	...
	{IR2_RADIO_BAND,			MSG_MODE_UP_LESS_THAN,		MSG_FM_BAND					},
	...
	{IR2_RADIO_SCAN,			MSG_MODE_DOWN,			    MSG_FM_SCAN					},
};
...
const ORDER_CFG ORDER_PLAYER_IR[]=
{
	...
	{IR2_PLAYER_ID3,			MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_ID3				},
	{IR2_PLAYER_SCH,			MSG_MODE_DOWN,			    MSG_MUSIC_SEARCH			},
};
...
const ORDER_CFG ORDER_BT_IR[]=
{
	...
	{IR2_BT_REJECT,				MSG_MODE_UP_LESS_THAN,	MSG_BT_CALL_REJECT			},
#if defined(_GX_CHANGE_KEYMAP_)
#if defined(_CONNECT_BT_PHONE_)
	{IR2_SYSTEM_CONNECT, 		MSG_MODE_DOWN_DELEY,		MSG_BT_CONNECT_CTL 		},
#endif	
#endif
...
const ORDER_CFG ORDER_OTHERS_IR[]=
{
	...
	{IR_VALUE3_BAND, 			MSG_MODE_DOWN_DELEY,		MSG_AUD_EQ					},
	{IR_VALUE3_MODE, 			MSG_MODE_DOWN_DELEY,		MSG_AUD_LOUD				},
	{IR2_SETTING_CLK,			MSG_MODE_UP_LESS_THAN,		MSG_CLOCK_DISP				},
	{IR2_SETTING_CLK,			MSG_MODE_DOWN_DELEY,		MSG_CLOCK_ADJ				},
};
