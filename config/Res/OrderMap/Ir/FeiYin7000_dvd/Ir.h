...
#define IR_PLAYER_M0														IR_VALUE_CLK
...
#define IR_PLAYER_M8														IR_VALUE_BACK
#define IR_PLAYER_M9														IR_VALUE_NEXT
...
#define IR_PLAYER_MP3JPGMP4										        	IR_VALUE_BAND

/*---------------------------------------------------------------------------------------------------
	蓝牙
*---------------------------------------------------------------------------------------------------*/

#define IR_BT_M0															IR_VALUE_CLK
...
#define IR_BT_M8															IR_VALUE_BACK
#define IR_BT_M9															IR_VALUE_NEXT
#define IR_BT_STAR															IR_VALUE_START
#define IR_BT_WELL															IR_VALUE_WELL
#define IR_BT_DEL															IR_VALUE_MODE
