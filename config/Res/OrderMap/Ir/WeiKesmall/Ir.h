...
#if defined(_SUPPORT_RDS_IR_)
#define IR_SYSTEM_AF														IR_VALUE_ST
#define IR_SYSTEM_TA														IR_VALUE_MUTE
#else
#define IR_SYSTEM_AF														IR_VALUE_M7
#define IR_SYSTEM_TA														IR_VALUE_LOUD
#endif
#endif
...
#define IR_RADIO_AMS														IR_VALUE_M8
...
#define IR_RDS_AF															IR_VALUE_M7
#define IR_RDS_TA															IR_VALUE_MUTE
#define IR_RDS_PTY															IR_VALUE_M9
...
#define IR_PLAYER_SCH														IR_VALUE_M8
...
#define IR_BT_STAR															IR_VALUE_MUTE
#define IR_BT_WELL															IR_VALUE_CLK
...
#if defined(_CHANGE_PLAY_FUNCTION_)
#define IR_SETTING_EQ														IR_VALUE_M9
#define IR_SETTING_LOUD														IR_VALUE_M7
#else
#define IR_SETTING_EQ														IR_RESPONSE_NULL
#define IR_SETTING_LOUD														IR_RESPONSE_NULL
#endif
