...
const ORDER_CFG ORDER_SYSTEM_IR[]=
{
	...
	{IR_SYSTEM_TA,				MSG_MODE_DOWN_DELEY,		MSG_RDS_TA					},
	{IR_SYSTEM_AF,				MSG_MODE_DOWN_DELEY,		MSG_RDS_AF					},
#else
...
const ORDER_CFG ORDER_PLAYER_IR[]=
{
	...
	{IR_PLAYER_M5,				MSG_MODE_UP_LESS_THAN ,		MSG_MUSIC_SUB_10			},
	{IR_PLAYER_M5,				MSG_MODE_DOWN_DELEY,		MSG_MUSIC_PREV_FOLDER		},
	{IR_PLAYER_M6,				MSG_MODE_UP_LESS_THAN ,		MSG_MUSIC_RDM 		   	    },
...
#if defined(_CHANGE_BAND_ANSWER_)
	{IR_BT_REDIAL,				MSG_MODE_DOWN,			MSG_BT_ANSWER_REDIAL		},
#else
...
#if defined(_YONGHE_CD3000_SPECIAL_)
	{IR_SETTING_SEL,			MSG_MODE_DOWN_DELEY,		MSG_CLOCK_SEL				},
#else	
