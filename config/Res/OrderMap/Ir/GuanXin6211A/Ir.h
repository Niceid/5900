...
#define IR_BT_STAR															IR_VALUE_ADD10
#define IR_BT_WELL															IR_VALUE_GOTO
#define IR_BT_DEL															IR_VALUE_OSD

#define IR_BT_PAUSE															IR_VALUE_PLAY
#define IR_BT_NEXT															IR_VALUE_NEXT
#define IR_BT_BACK															IR_VALUE_BACK
#define IR_BT_ANSWER														IR_VALUE_PBC
#define IR_BT_REJECT														IR_VALUE_OSD
#define IR_BT_REDIAL														IR_VALUE_PBC
