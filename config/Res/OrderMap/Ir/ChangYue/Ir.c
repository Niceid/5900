...
const ORDER_CFG ORDER_SYSTEM_IR[]=
{
	...
	{IR_VALUE_SCAN,				MSG_MODE_UP_LESS_THAN,		MSG_SYS_MODE_SUB_SD			},
#endif
};
...
const ORDER_CFG ORDER_RADIO_IR[]=
{
	...
	{IR_RADIO_SCAN,				MSG_MODE_DOWN_DELEY,		MSG_FM_AUTO_SAVE			},
	{IR_RADIO_SCAN,				MSG_MODE_UP_LESS_THAN,	    MSG_FM_BROWSE				},
};
