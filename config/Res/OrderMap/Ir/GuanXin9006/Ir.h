...
#define IR1_PLAYER_SCH														IR_VALUE1_M0
...
#define IR_BT_REDIAL                                                        IR_VALUE_M5
#else
#define IR_BT_ANSWER														IR_RESPONSE_NULL
#define IR_BT_REJECT														IR_VALUE_BAND
#define IR_BT_REDIAL                                                        IR_VALUE_MODE
#endif

#if defined(_GX_CHANGE_KEYMAP_)
#define IR_SYSTEM_CONNECT                                                   IR_VALUE_M6
#endif
...
#define IR1_BT_REJECT														IR_VALUE1_BAND
...
#define IR1_RECORD_PAUSE													IR_VALUE1_PLAY
