...
const ORDER_CFG ORDER_PLAYER_IR[]=
{
	...
	{IR1_PLAYER_ADD_10,			MSG_MODE_DOWN,				MSG_MUSIC_ADD_10			},	
	{IR1_PLAYER_SUB_10,			MSG_MODE_DOWN,				MSG_MUSIC_SUB_10			},	
...
#if defined(_CHANGE_IR_MAP_)
	{IR1_BT_PAUSE1,				MSG_MODE_DOWN,			MSG_BT_PP					},
#endif
