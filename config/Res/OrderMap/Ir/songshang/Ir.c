...
{//enter here
	...
	//#endif
	#if REC_EN
	{IR_RECORD_START,				MSG_MODE_DOWN_DELEY,				MSG_SYS_REC		},	
	#endif
...
{//enter here
	...
	//{IR_RADIO_ST,				MSG_MODE_UP_LESS_THAN,		MSG_FM_AUTO_SAVE					},
	...
	//{IR_RADIO_SCAN,				MSG_MODE_UP_LESS_THAN,		MSG_FM_SCAN					},
	//{IR_RADIO_BACK,				MSG_MODE_DOWN_DELEY,		MSG_FM_PREV_STEP			},
};
...
{//enter here
	...
	{IR_PLAYER_U_SD,				MSG_MODE_UP_LESS_THAN,			    MSG_MUSIC_U_SD			},
};
...
{//enter here
	...
	//{IR_BT_REDIAL, 				MSG_MODE_UP_LESS_THAN,		    MSG_BT_REDIAL			},
...
{//enter here
	...
	//{IR_BT_DEL,					MSG_MODE_DOWN,		    MSG_BT_DEL					},
};
