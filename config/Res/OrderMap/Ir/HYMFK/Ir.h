...
#define IR1_BT_ANSWER														IR_VALUE_BAND1
#define IR1_BT_REJECT														IR_RESPONSE_NULL

#if defined(_SUPPORT_IPHONE_SIR_)
#if defined(_ENABLE_SIRI_FUNCTION_)
#define IR_BT_SIR															IR_VALUE_SEL
#define IR1_BT_SIR															IR_VALUE_SEL1
#else
#define IR_BT_SIR															IR_VALUE_BAND
#define IR1_BT_SIR															IR_VALUE_BAND1
#endif
#endif
/*---------------------------------------------------------------------------------------------------
	录音
