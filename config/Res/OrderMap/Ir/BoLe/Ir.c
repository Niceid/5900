...
{//enter here
	...
	{IR1_SYSTEM_POWER_MUTE,		MSG_MODE_UP_LESS_THAN,				MSG_SYS_MUTE				},
	{IR1_SYSTEM_POWER_MUTE,		MSG_MODE_DOWN_DELEY,				MSG_SYS_POWER				},
#endif
...
{//enter here
	...
	{IR1_RADIO_NAV_UP, 			MSG_MODE_UP_LESS_THAN,		MSG_FM_SLECT_UP 			},
...
{//enter here
	{IR_PLAYER_M1,				MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_PP				},
	{IR_PLAYER_M2,				MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_INT				},
	{IR_PLAYER_M3,				MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_RPT				},
	{IR_PLAYER_M4,				MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_RDM				},
	...
	{IR1_PLAYER_RPT,			MSG_MODE_DOWN,				MSG_MUSIC_RPT				},
};
...
{//enter here
	...
	{IR_BT_NEXT,				MSG_MODE_UP_LESS_THAN,			MSG_BT_NEXT_FILE			},
	{IR_BT_BACK,				MSG_MODE_UP_LESS_THAN,			MSG_BT_PREV_FILE			},
	{IR_BT_ANSWER,				MSG_MODE_UP_LESS_THAN,			MSG_BT_ANSWER_CALL			},
	{IR_BT_REJECT,				MSG_MODE_UP_LESS_THAN,			MSG_BT_CALL_REJECT			},
	{IR_BT_REDIAL, 				MSG_MODE_DOWN,		            MSG_BT_REDIAL			    },
#if defined(_SUPPORT_CALL_RECORDS_)&&0
	{IR_BT_INFO,				MSG_MODE_DOWN,				    MSG_BT_INFO 				},
#endif
#if defined(_SPECIAL_SIR_FUNTION_)
	{IR_BT_SIRI,				MSG_MODE_DOWN_DELEY,		    MSG_BT_SIR 				},
#endif

    {IR1_BT_PAUSE,				MSG_MODE_UP_LESS_THAN,			MSG_BT_PP					},
	//{IR1_BT_NEXT,				MSG_MODE_UP_LESS_THAN,			MSG_BT_NEXT_FILE			},
	//{IR1_BT_BACK,				MSG_MODE_UP_LESS_THAN,			MSG_BT_PREV_FILE			},
	{IR1_BT_ANSWER,				MSG_MODE_UP_LESS_THAN,			MSG_BT_ANSWER_CALL2			},
	{IR1_BT_REJECT,				MSG_MODE_UP_LESS_THAN,			MSG_BT_CALL_REJECT2			},
	{IR1_BT_REDIAL, 			MSG_MODE_DOWN_DELEY,		    MSG_BT_REDIAL			    },
#if defined(_TALKING_VOL_CHANGE_)
	{IR1_BT_VOL_CHANGE,			MSG_MODE_DOWN,			        MSG_BT_VOL_CHANGE			},
#endif	
...
{//enter here
	{IR_BT_ANSWER,				MSG_MODE_UP_LESS_THAN,	MSG_BT_ANSWER_CALL			},
	{IR_BT_M0,					MSG_MODE_DOWN,	        MSG_BT_0					},
	{IR_BT_M1,					MSG_MODE_DOWN,			MSG_BT_1					},
#if defined(_SPECIAL_SIR_FUNTION_)
	{IR_BT_M2,					MSG_MODE_UP_LESS_THAN,	MSG_BT_2					},
#else
...
#if defined(_SUPPORT_CALL_RECORDS_)&&0
	{IR_BT_INFO,				MSG_MODE_DOWN,			MSG_BT_INFO					},
	{IR_BT_ADD,					MSG_MODE_DOWN,			MSG_BT_INFO_ADD				},
	{IR_BT_SUB,					MSG_MODE_DOWN,		    MSG_BT_INFO_SUB				},
...
const ORDER_CFG ORDER_PASSWORD_IR[]=
{
	//{IR_PASSWORD_NO_1, 			MSG_MODE_UP_LESS_THAN,			DISP_EVENT_PASSWORD_NO_1	},
	//{IR_PASSWORD_NO_2, 			MSG_MODE_UP_LESS_THAN,			DISP_EVENT_PASSWORD_NO_2	},
	//{IR_PASSWORD_NO_3, 			MSG_MODE_UP_LESS_THAN,			DISP_EVENT_PASSWORD_NO_3	},
	//{IR_PASSWORD_NO_4, 			MSG_MODE_UP_LESS_THAN,			DISP_EVENT_PASSWORD_NO_4	},
	
	//{IR_PASSWORD_ENTER,			MSG_MODE_UP_LESS_THAN,			DISP_EVENT_PASSWORD_ENTER	},
...
{//enter here
	...
	{IR_SETTING_MUTE,			MSG_MODE_UP_LESS_THAN,		MSG_SYS_MUTE				},
