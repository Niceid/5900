...
#if defined(IR1_CODE_POWER_MUTE)
...
#define IR1_RADIO_NAV_UP													IR_VALUE1_NAV_UP
...
#define IR1_PLAYER_PLAY														IR_VALUE1_NAV_UP
...
#define IR1_BT_PAUSE														IR_VALUE1_NAV_UP
#define IR1_BT_NEXT															IR_VALUE1_NEXT
#define IR1_BT_BACK															IR_VALUE1_BACK
#define IR1_BT_ANSWER														IR_VALUE1_BACK
#define IR1_BT_REJECT														IR_VALUE1_NEXT
#define IR1_BT_REDIAL                                                       IR_VALUE1_BACK
#if defined(_TALKING_VOL_CHANGE_)
#define IR1_BT_VOL_CHANGE													IR_VALUE1_BT_VOL
#endif
