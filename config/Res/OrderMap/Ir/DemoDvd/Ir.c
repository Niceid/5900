...
#if defined(_ADD_FAD_ADJUST_FUNCTION_)
    {IR_SYSTEM_FAD_SINGLE_R, 	MSG_MODE_DOWN_DELEY,		MSG_FAD_SINGLE_R			},
	{IR_SYSTEM_FAD_SINGLE_F, 	MSG_MODE_DOWN_DELEY,		MSG_FAD_SINGLE_F 			},
	{IR_SYSTEM_FAD_ALL,			MSG_MODE_DOWN_DELEY,		MSG_FAD_ALL					},
#endif
...
#if defined(_ADD_FAD_ADJUST_FUNCTION_)
    {IR_PLAYER_LEFT,			MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_LEFT				},
	{IR_PLAYER_RIGHT,			MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_RIGHT				},
	{IR_PLAYER_ENTER,			MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_ENTER				},
#else
