...
#if defined(_GDH5001_CHANGE_ANSWER_REJECT_)
...
#endif
#if defined(_GDH5001_SPECIAL_IR_)
    {IR_SYSTEM_PTY,			MSG_MODE_UP_LESS_THAN,		MSG_PTY_CLOCK				},
	{IR_SYSTEM_PTY,			MSG_MODE_DOWN_DELEY,		MSG_PTY_CLOCK				},
#endif
