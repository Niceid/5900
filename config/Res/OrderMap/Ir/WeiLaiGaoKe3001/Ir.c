...
{//enter here
#if defined(_FY_CHANGE_POWER_KEY_)
    {IR_SYSTEM_POWER,			MSG_MODE_UP_LESS_THAN,		MSG_SYS_POWER				},
    {IR_SYSTEM_POWER,			MSG_MODE_DOWN_DELEY,		MSG_SYS_POWER				},
#else
	...
	{IR_VALUE_BT,				MSG_MODE_DOWN,				MSG_SYS_BT_ANSWER			},
	{IR_VALUE_BAND,				MSG_MODE_DOWN,				MSG_SYS_RADIO_BAND			},
#endif
};
...
#if defined(_WLGK3001_IR_FUNTION_)
    {IR_RADIO_NEXT, 			MSG_MODE_UP_LESS_THAN , 	MSG_FM_SLECT_UP				},	
    {IR_RADIO_NEXT, 			MSG_MODE_DOWN_DELEY,		MSG_FM_NEXT_SEEK			},
    {IR_RADIO_BACK, 			MSG_MODE_UP_LESS_THAN , 	MSG_FM_SLECT_DOWN			},
