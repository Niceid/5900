...
const ORDER_CFG ORDER_RADIO_IR[]=
{
	...
	{IR1_RADIO_NEXT,			MSG_MODE_DOWN ,				MSG_FM_NEXT_SEEK			},	
	//{IR1_RADIO_NEXT,			MSG_MODE_DOWN_DELEY,		MSG_FM_NEXT_STEP			},
	{IR1_RADIO_BACK,			MSG_MODE_DOWN ,				MSG_FM_PREV_SEEK			},
	...
	{IR1_RADIO_BACK_STEP, 		MSG_MODE_DOWN_LOOP,			MSG_FM_PREV_STEP1			},
	{IR1_RADIO_NEXT_STEP, 		MSG_MODE_DOWN_LOOP,			MSG_FM_NEXT_STEP1			}, 
};
...
{	
	...
	{IR_PLAYER_STOP,			MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_STOP				},
	{IR_PLAYER_RETURN,			MSG_MODE_DOWN_DELEY,		MSG_MUSIC_RETURN			},
	...
	{IR_PLAYER_M4, 				MSG_MODE_DOWN_DELEY,		MSG_MUSIC_MP3_JPG_MP4		},
#endif

	{IR_PLAYER_FORMAT, 			MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_FORMAT			},
	{IR_PLAYER_ID3,				MSG_MODE_DOWN_DELEY,		MSG_MUSIC_ID3				},
	
	{IR_PLAYER_RDM, 			MSG_MODE_DOWN,				MSG_MUSIC_RDM				},
	
	{IR_PLAYER_RPT, 			MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_RPT				},
	...
	{IR_PLAYER_OSD,				MSG_MODE_DOWN ,				MSG_MUSIC_OSD				},
	...
	{IR_PLAYER_TITLE,			MSG_MODE_DOWN,				MSG_MUSIC_TITLE 			},
	...
	{IR1_PLAYER_NEXT,			MSG_MODE_DOWN,				MSG_MUSIC_NEXT_FILE			},
	{IR1_PLAYER_FORWARD,		MSG_MODE_DOWN,				MSG_MUSIC_FF				},
	
	{IR1_PLAYER_BACK,			MSG_MODE_DOWN,				MSG_MUSIC_PREV_FILE			},
	{IR1_PLAYER_BACKWARD,		MSG_MODE_DOWN,				MSG_MUSIC_FR				},
    
    {IR1_PLAYER_ID3,			MSG_MODE_DOWN,				MSG_MUSIC_ID3				},
    {IR1_PLAYER_SCH,			MSG_MODE_DOWN,				MSG_MUSIC_SEARCH			},

	{IR1_PLAYER_PLAYPAUSE,		MSG_MODE_DOWN,				MSG_MUSIC_PP				},
	{IR1_PLAYER_STOP,			MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_STOP				},
	{IR1_PLAYER_RETURN,			MSG_MODE_DOWN_DELEY,		MSG_MUSIC_RETURN			},

    {IR1_PLAYER_UP,				MSG_MODE_DOWN,				MSG_MUSIC_UP				},
    {IR1_PLAYER_DOWN,			MSG_MODE_DOWN,				MSG_MUSIC_DOWN				},
    {IR1_PLAYER_LEFT,			MSG_MODE_DOWN,				MSG_MUSIC_LEFT				},
    {IR1_PLAYER_RIGHT,			MSG_MODE_DOWN,				MSG_MUSIC_RIGHT 			},
    {IR1_PLAYER_ENTER,			MSG_MODE_DOWN,				MSG_MUSIC_ENTER 			},

	{IR1_PLAYER_SETUP,			MSG_MODE_DOWN,				MSG_MUSIC_SETUP 			},
	{IR1_PLAYER_TITLE,			MSG_MODE_DOWN,				MSG_MUSIC_TITLE 			},
	{IR1_PLAYER_PBC,			MSG_MODE_DOWN,				MSG_MUSIC_PBC				},
	{IR1_PLAYER_CHANNEL,		MSG_MODE_DOWN,				MSG_MUSIC_CHANNEL			},
};
...
const ORDER_CFG ORDER_PLAYER_IR_2NDF[]=
{
	...
	{IR1_PLAYER_ENTER, 			MSG_MODE_DOWN,				MSG_MUSIC_SEL				},
};
