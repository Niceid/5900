...
#define IR_SYSTEM_TA														IR_VALUE_START
#endif
...
#define IR_RDS_PTY															IR_VALUE_WELL
...
#define IR_PLAYER_M0														IR_VALUE_NULL
...
#define IR_PLAYER_M7														IR_VALUE_NULL
#define IR_PLAYER_M8														IR_VALUE_NULL
#define IR_PLAYER_M9														IR_VALUE_NULL

#define IR_PLAYER_NEXT														IR_VALUE_NEXT
#define IR_PLAYER_BACK														IR_VALUE_BACK
#define IR_PLAYER_CHANNEL													IR_VALUE_NULL
...
#if defined(_ENABLE_NEW_FUNTION_)
#define IR_PLAYER_ENTER														IR_VALUE_NULL
#else
#define IR_PLAYER_ENTER														IR_VALUE_AUDIO
#endif
...
#if defined(_ENABLE_NEW_FUNTION_)
#define IR_SETTING_SEL														IR_VALUE_NULL
#else
#define IR_SETTING_SEL														IR_VALUE_AUDIO
#endif
