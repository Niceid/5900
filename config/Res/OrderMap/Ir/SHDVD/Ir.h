...
#define IR_RADIO_UP_PRESET													IR_VALUE_UP
#define IR_RADIO_DOWN_PRESET												IR_VALUE_DOWN
#define IR_RADIO_PREV_PRESET												IR_VALUE_LEFT
#define IR_RADIO_NEXT_PRESET												IR_VALUE_RIGHT

#define IR_RADIO_ST															IR_VALUE_ST
#define IR_RADIO_LOC														IR_VALUE_LOC

#define IR_RADIO_NAVI_UP													IR_VALUE_NAV_UP
#define IR_RADIO_NAVI_DOWN													IR_VALUE_NAV_DOWN
...
#define IR_BT_STAR															IR_VALUE_M10
#define IR_BT_WELL															IR_VALUE_GOTO
#define IR_BT_DEL															IR_VALUE_LEFT
