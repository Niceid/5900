...
#define IR_RADIO_FORWARD													IR_VALUE_FORWARD
#define IR_RADIO_BACKWARD													IR_VALUE_BACKWARD
...
#define IR_RADIO_SCAN														IR_VALUE_MENU
...
#define IR_PLAYER_FORWARD													IR_VALUE_FORWARD
#define IR_PLAYER_BACKWARD													IR_VALUE_BACKWARD
...
#define IR_PLAYER_RDM														IR_VALUE_ANGLE
#define IR_PLAYER_INT														IR_VALUE_SETUP	
...
#define IR_BT_WELL															IR_VALUE_MENU
#define IR_BT_DEL															IR_VALUE_BACKWARD

#define IR_BT_PAUSE															IR_VALUE_PLAY
#define IR_BT_NEXT															IR_VALUE_NEXT
#define IR_BT_BACK															IR_VALUE_BACK
#define IR_BT_ANSWER														IR_VALUE_SLOW
#define IR_BT_REJECT														IR_VALUE_CLK
