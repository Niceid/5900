...
#define IR_RADIO_ST															IR_VALUE_ST//IR_VALUE_AUDIO
...
#define IR_PLAYER_MENU														IR_VALUE_AMS
...
#define IR_PLAYER_OSD														IR_RESPONSE_NULL 
#define IR_PLAYER_ROOT														IR_VALUE_ROOT
...
#define IR_SETTING_CLK														IR_VALUE_DISP
