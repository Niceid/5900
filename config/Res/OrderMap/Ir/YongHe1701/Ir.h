...
#define IR_RADIO_M7															IR_VALUE_M7
#define IR_RADIO_M8															IR_VALUE_M8
#define IR_RADIO_M9															IR_VALUE_M9
#define IR_RADIO_M10														IR_VALUE_M0
...
#define IR_BT_ANSWER														IR_VALUE_NULL
#define IR_BT_REJECT														IR_VALUE_NULL
