...
#if defined(_ENABLE_SPECIAL_REJECT_)
	{IR_BT_NEXT,				MSG_MODE_DOWN,			MSG_BT_ANSWER_CALL			},
	{IR_BT_BACK,				MSG_MODE_DOWN,			MSG_BT_CALL_REJECT			},	
	{IR_BT_NEXT, 				MSG_MODE_DOWN_DELEY,	MSG_BT_REDIAL				},	
