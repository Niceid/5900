...
{/*********value********************mode************************order******/
#if 1
	{KEY_SYSTEM_MODE,			MSG_MODE_UP_LESS_THAN,				MSG_SYS_POWER				},
	{KEY_SYSTEM_POWER,			MSG_MODE_UP_LESS_THAN,				MSG_SYS_POWER				},
#else
#if defined(_SLA6802_ANSWER_REJECT_)
    {KEY_SYSTEM_MODE,			MSG_MODE_UP_LESS_THAN,		MSG_SYS_POWER				},
#if defined(_ADD_KEY_TA_)
    {KEY_SYSTEM_MODE,			MSG_MODE_DOWN_DELEY,		MSG_RDS_TA				},
#endif
#else
	{KEY_SYSTEM_POWER,			MSG_MODE_DOWN,				MSG_SYS_MODE				},
#endif
...
//key_printf("KEY_SYSTEM_POWER***");
//key_printf("KEY_SYSTEM_MODE");
...
{
#if 1
	{KEY_RADIO_M1,				MSG_MODE_UP_LESS_THAN,		MSG_FM_M6					},
	{KEY_RADIO_M2,				MSG_MODE_UP_LESS_THAN,		MSG_FM_M5					},
	{KEY_RADIO_M3,				MSG_MODE_UP_LESS_THAN,		MSG_FM_M4					},
	{KEY_RADIO_M4,				MSG_MODE_UP_LESS_THAN,		MSG_FM_M3					},
	{KEY_RADIO_M5,				MSG_MODE_UP_LESS_THAN,		MSG_FM_M2					},
	{KEY_RADIO_M6,				MSG_MODE_UP_LESS_THAN,		MSG_FM_M1					},
#else
...
#if defined(_CHANGE_KEY_FUNCTION_)
...
#if defined(_ADD_AMS_SEEK_FUNCTION_)
    {KEY_RADIO_AMS,			    MSG_MODE_UP_LESS_THAN,		MSG_FM_BAND			    	},
	{KEY_RADIO_AMS,			    MSG_MODE_DOWN_DELEY,		MSG_FM_AUTO_SAVE			},
#endif
#if defined(KEY_RADIO_NAVI_UP)
...
{
#if defined(_ENABLE_ID3_SET_)
    {KEY_PLAYER_ID3_SCH,		 MSG_MODE_UP_LESS_THAN,		MSG_SYS_ID3				},
#endif
	...
	{KEY_OTHERS_SEL,			MSG_MODE_DOWN_DELEY,		MSG_SYS_SIR					},
#else
	{KEY_OTHERS_SEL,			MSG_MODE_UP_LESS_THAN,		MSG_USER_SEL				},
