...
#endif
#define KEY_SYSTEM_BT														KEY_VALUE_AMS

#if defined(_TL_KEY_TO_RADIO_)
#define KEY_SYSTEM_RADIO													KEY_VALUE_BAND
#endif
/*---------------------------------------------------------------------------------------------------
	收音
/---------------------------------------------------------------------------------------------------*/
...
#define KEY_RADIO_BAND														KEY_RESPONSE_NULL
...
#define KEY_PLAYER_ID3														KEY_RESPONSE_NULL
...
#define KEY_OTHERS_A_SPK													KEY_VALUE_A_SPK
#define KEY_OTHERS_B_SPK													KEY_VALUE_B_SPK
