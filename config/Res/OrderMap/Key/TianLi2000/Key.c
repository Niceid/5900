...
{/*********value********************mode************************order******/
	...
	{KEY_SYSTEM_MODE,			MSG_MODE_UP_LESS_THAN,		MSG_ALARM_MODE				},
	{KEY_SYSTEM_MODE,			MSG_MODE_DOWN_DELEY,		MSG_ALARM_MODE				},
#else
	{KEY_SYSTEM_MODE, 			MSG_MODE_DOWN,				MSG_SYS_MODE				},
#endif

#if defined(_TL_KEY_TO_RADIO_)
	{KEY_SYSTEM_RADIO, 			MSG_MODE_DOWN,				MSG_SYS_RADIO				},
#endif

#if defined(ENABLE_BT_MODE_)
	{KEY_SYSTEM_BT,				MSG_MODE_UP_LESS_THAN,		MSG_SYS_BT					},
#endif
...
const ORDER_CFG ORDER_OTHERS_KEY[]=
{
...
#elif defined(SUPPORT_LED_ADJUST)
    {KEY_OTHERS_DISP,			MSG_MODE_UP_LESS_THAN,		MSG_CLOCK_LED 				},
    {KEY_OTHERS_DISP,			MSG_MODE_DOWN_DELEY,		MSG_CLOCK_LED				},
#else
	...
	{KEY_OTHERS_ADD,			MSG_MODE_DOWN_LOOP,			MSG_VOL_B_SUB				},
	{KEY_OTHERS_SUB,			MSG_MODE_DOWN_LOOP,			MSG_VOL_A_SUB				},

	{KEY_OTHERS_A_SPK,			MSG_MODE_DOWN_LOOP,			MSG_VOL_A_ADD				},
	{KEY_OTHERS_B_SPK,			MSG_MODE_DOWN_LOOP,			MSG_VOL_B_ADD				},
#else
	{KEY_OTHERS_ADD,			MSG_MODE_DOWN_LOOP,			MSG_VOL_ADD					},
	{KEY_OTHERS_SUB,			MSG_MODE_DOWN_LOOP,			MSG_VOL_SUB					},

	{KEY_OTHERS_A_SPK,			MSG_MODE_DOWN,				MSG_ADJ_A_SPK					},
	{KEY_OTHERS_B_SPK,			MSG_MODE_DOWN,				MSG_ADJ_B_SPK					},
#endif
