...
const ORDER_CFG ORDER_PLAYER_KEY[]=
{
	...
	{KEY_VALUE_NAVI_UP, 		MSG_MODE_DOWN_DELEY,		MSG_MUSIC_ADD_10			},
	{KEY_VALUE_NAVI_DOWN,		MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_PLAY_MODE 		},
	{KEY_VALUE_NAVI_DOWN,		MSG_MODE_DOWN_DELEY,		MSG_MUSIC_SUB_10			},
};
...
const ORDER_CFG ORDER_DAB_KEY[]=
{
	...
	{KEY_RADIO_BAND,			MSG_MODE_UP_LESS_THAN,		MSG_FM_AUTO_SAVE			    	},
