...
const ORDER_CFG ORDER_SYSTEM_KEY[]=
{
...
#if defined(KEY_SYSTEM_MODE_TIME)
	{KEY_SYSTEM_MODE_TIME,		MSG_MODE_UP_LESS_THAN,		MSG_SYS_MODE_CLOCK			},
	{KEY_SYSTEM_MODE_TIME,		MSG_MODE_DOWN_DELEY,		MSG_SYS_MODE_CLOCK			},
#endif
#if defined(BAND_ACTION_ANSWER_REJECT)
    {KEY_SYSTEM_BAND_ANSWER,	MSG_MODE_UP_LESS_THAN,		MSG_BAND_ANSWER				},
    {KEY_SYSTEM_BAND_ANSWER,	MSG_MODE_DOWN_DELEY,		MSG_BAND_ANSWER				},
#endif
	...
	//{KEY_VALUE_BAND, 			MSG_MODE_DOWN_DELEY,		MSG_CLEAR_MEMORY 			},
#endif

#if defined(_ENABLE_DISP_BT_NAME_)
	{KEY_VALUE_SCAN,			MSG_MODE_DOWN_DELEY,		MSG_SYS_BT_NAME 			},
#endif

#if defined(_JTI_KEY_FUNTION_)
	{KEY_VALUE_MODE1,			MSG_MODE_DOWN,				MSG_SYS_MODE				},
#endif
};
...
const ORDER_CFG ORDER_RADIO_KEY[]=
{
	...
	{KEY_RADIO_SCAN,			MSG_MODE_UP_LESS_THAN,		MSG_FM_SCAN					},
...
const ORDER_CFG ORDER_BT_KEY[]=
{
	...
	//{KEY_BT_ANSWER, 			ORDER_MODE_UP_LESS_THAN,	MSG_BT_ANSWER_REJECT 		},
	//{KEY_BT_REJECT, 			ORDER_MODE_DOWN_DELEY,		MSG_BT_ANSWER_REJECT 		},
#if defined(_TALKING_VOL_CHANGE_)	
	{KEY_BT_VOL_CHANGE, 		MSG_MODE_DOWN,				MSG_BT_VOL_CHANGE			},
#endif
...
#endif
#if defined(TIME_ACTION_ANSWER_REJECT)
    {KEY_OTHERS_DISP,			MSG_MODE_UP_LESS_THAN,		MSG_CLOCK_ANSWER			},
    {KEY_OTHERS_DISP,			MSG_MODE_DOWN_DELEY,		MSG_CLOCK_ANSWER			},
#else
	{KEY_OTHERS_DISP,			MSG_MODE_UP_LESS_THAN,		MSG_CLOCK_DISP				},
	{KEY_OTHERS_DISP,			MSG_MODE_DOWN_DELEY,		MSG_CLOCK_ADJ				},
#endif
#if !defined(_DISABLE_SEL_KEY_FUNCTION_)
