...
#if defined(KEY_MODE_TIME)
#define KEY_SYSTEM_MODE_TIME 												KEY_VALUE_MODE_TIME
#endif

#define KEY_SYSTEM_BAND_ANSWER 												KEY_VALUE_BAND
...
#define KEY_PLAYER_ID3														KEY_VALUE_NULL
...
#define KEY_BT_VOL_CHANGE													KEY_VALUE_AMS
/*---------------------------------------------------------------------------------------------------
	录音
*---------------------------------------------------------------------------------------------------*/
