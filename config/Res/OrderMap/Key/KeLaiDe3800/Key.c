...
{/*********value********************mode************************order******/
    ...
    {KEY_VALUE_NEXT,			MSG_MODE_UP_LESS_THAN,		MSG_SYS_NEXT1 				},
    {KEY_VALUE_NEXT,			MSG_MODE_DELEY_LOOP,		MSG_SYS_NEXT1				},
    {KEY_VALUE_NEXT,			MSG_MODE_UP_MORE_THAN,		MSG_SYS_NEXT1				},

    {KEY_VALUE_PREV,			MSG_MODE_UP_LESS_THAN,		MSG_SYS_PREV1				},
    {KEY_VALUE_PREV,			MSG_MODE_DELEY_LOOP,		MSG_SYS_PREV1				},
    {KEY_VALUE_PREV,			MSG_MODE_UP_MORE_THAN,		MSG_SYS_PREV1				},
#endif

#if defined(_ENABLE_AUX_VERSION_)
	{KEY_VALUE_M1,				MSG_MODE_UP_LESS_THAN,		MSG_SYS_M1					},
	{KEY_VALUE_M1,				MSG_MODE_DOWN_DELEY,		MSG_SYS_M1					},
#endif
};
...
#if defined(_CHANGE_PLAYER_FUNC_)
