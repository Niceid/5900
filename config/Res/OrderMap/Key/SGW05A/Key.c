...
{/*********value********************mode************************order******/
	...
	{KEY_SYSTEM_BT,			   MSG_MODE_DOWN,				MSG_SYS_BT				},
#endif

#if defined(_ENABLE_MIC_REC_)
	{KEY_VALUE_REC,			   MSG_MODE_DOWN,		        MSG_RECORD_MIC			},
#endif

#if defined(_CHANGE_USB_SD_FUNTION_)
	{KEY_VALUE_MP3,			   MSG_MODE_DOWN,				MSG_SYS_SUB_SD 		},
#endif

#if defined(_SUPPORT_PLAYER_NAMES_)
	{KEY_VALUE_BACK,			   MSG_MODE_DOWN,			MSG_SYS_PLAYER_NAMES 	},
#endif
