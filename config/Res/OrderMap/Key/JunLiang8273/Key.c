...
#if defined(_ENABLE_PLAY_FUNTION_)
    {KEY_PLAYER_NEXT,			MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_NEXT_FILE 		},
	{KEY_PLAYER_NEXT,			MSG_MODE_DOWN_DELEY,		MSG_MUSIC_RDM				},
    
    {KEY_PLAYER_BACK,			MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_PREV_FILE 		},
    {KEY_PLAYER_BACK,			MSG_MODE_DOWN_DELEY,		MSG_MUSIC_RPT 				},
#else
	{KEY_PLAYER_NEXT,			MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_NEXT_FILE			},
...
const ORDER_CFG ORDER_BT_KEY[]=
{
	...
	{KEY_BT_ANSWER, 			MSG_MODE_DOWN_DELEY,		MSG_BT_CONNECT_CTL 			},
	{KEY_BT_ANSWER_2,			MSG_MODE_DOWN_DELEY,		MSG_BT_CONNECT_CTL			},
#endif
};	
...
const ORDER_CFG ORDER_OTHERS_KEY[]=
{
	...
	{KEY_VALUE_BAND_AMS, 		MSG_MODE_UP_LESS_THAN,		MSG_SYS_RESET_VIEW				},
	{KEY_VALUE_BAND_AMS, 		MSG_MODE_DOWN_DELEY,		MSG_SYS_RESET_VIEW				},
#endif
};
