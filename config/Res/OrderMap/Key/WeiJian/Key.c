...
{/*********value********************mode************************order******/
	...
	{KEY_VALUE_BAND_TIME,		MSG_MODE_UP_LESS_THAN,		MSG_SYS_BAND_CLOCK			},
	{KEY_VALUE_BAND_TIME,		MSG_MODE_DOWN_DELEY,		MSG_SYS_BAND_CLOCK			},
#endif

#if defined(_SUPPORT_EXT_MEMORY_)
	{KEY_VALUE_AMS,				MSG_MODE_DOWN_DELEY,		MSG_CLEAR_MEMORY 			},
#endif
...
const ORDER_CFG ORDER_PLAYER_KEY[]=
{
	...
	{KEY_PLAYER_SCH,			MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_SEARCH			},
