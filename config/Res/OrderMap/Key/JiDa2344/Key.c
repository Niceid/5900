...
{/*********value********************mode************************order******/
	...
	{KEY_VALUE_ST,				MSG_MODE_DOWN,				MSG_SYS_LIGHT				},
#endif
...
const ORDER_CFG ORDER_PLAYER_KEY[]=
{
	...
	{KEY_PLAYER_M6,				MSG_MODE_DOWN,				MSG_MUSIC_RDM				},
	{KEY_PLAYER_M5,				MSG_MODE_DOWN_DELEY,		MSG_MUSIC_PREV_FOLDER		},
	{KEY_PLAYER_M4,				MSG_MODE_DOWN_DELEY,		MSG_MUSIC_NEXT_FOLDER		},
	{KEY_PLAYER_M5,				MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_SUB_10			},
	{KEY_PLAYER_M4,				MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_ADD_10			},
...
const ORDER_CFG ORDER_BT_KEY[]=
{
	...
	{KEY_BT_REJECT,				MSG_MODE_DOWN_DELEY,				MSG_BT_DISCONNECT			},
};	
