...
{/*********value********************mode************************order******/
    ...
    {KEY_SYSTEM_POWER_MUTE,		MSG_MODE_UP_LESS_THAN,		MSG_SPECIAL_MUTE			},
#endif	
    ...
    {KEY_VALUE_MODE_SEL,		MSG_MODE_UP_LESS_THAN,		MSG_MODE_SEL_CLK				},
    {KEY_VALUE_MODE_SEL,		MSG_MODE_DOWN_DELEY,		MSG_MODE_SEL_CLK				},
#endif

#if defined(_SH_SWITCH_TO_RADIO_)
	{KEY_VALUE_BAND_AMS,		MSG_MODE_UP_LESS_THAN,		MSG_SYS_FM				},
	{KEY_VALUE_BAND_AMS,		MSG_MODE_DOWN_DELEY,		MSG_SYS_FM				},
#endif
...
const ORDER_CFG ORDER_PLAYER_KEY[]=
{
	...
	{KEY_PLAYER_M1,				MSG_MODE_DOWN,				MSG_MUSIC_ID3				},
