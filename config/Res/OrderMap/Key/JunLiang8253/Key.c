...
{/*********value********************mode************************order******/
	...
	{KEY_VALUE_M1,				MSG_MODE_UP_LESS_THAN,		MSG_PLAY_TIME				},
	{KEY_VALUE_M1,				MSG_MODE_DOWN_DELEY,		MSG_PLAY_TIME				},
#endif

#if defined(_ENABLE_RECORD_KEY_)
	{KEY_VALUE_M2,				MSG_MODE_UP_LESS_THAN,		MSG_RECORD_INT				},
#endif

#if defined(_SPECIAL_MENU_SET_)
	{KEY_VALUE_M4,				MSG_MODE_UP_LESS_THAN,		MSG_USER_MENU				},
	{KEY_VALUE_M4,				MSG_MODE_DOWN_DELEY,		MSG_USER_MENU				},
#endif

	{KEY_VALUE_M3,				MSG_MODE_DOWN_DELEY,		MSG_SYS_MUTE				},
...
const ORDER_CFG ORDER_RADIO_KEY[]=
{
	...
	{KEY_RADIO_M5,				MSG_MODE_DOWN_DELEY,		MSG_FM_PREV_SEEK			},
	//{KEY_RADIO_M6,				MSG_MODE_DOWN_DELEY,		MSG_FM_NEXT_SEEK			},
	{KEY_RADIO_M6,				MSG_MODE_DOWN_DELEY,		MSG_FM_NEXT_STEP			},
...
const ORDER_CFG ORDER_PLAYER_KEY[]=
{
	...
	//{KEY_PLAYER_M2,				MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_INT				},
	{KEY_PLAYER_M3,				MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_RPT				},
	//{KEY_PLAYER_M4,				MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_RDM				},
	//{KEY_PLAYER_M5,				MSG_MODE_DOWN_DELEY,		MSG_MUSIC_PREV_FOLDER		},
	//{KEY_PLAYER_M6,				MSG_MODE_DOWN_DELEY,		MSG_MUSIC_NEXT_FOLDER		},
	{KEY_PLAYER_M5,				MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_PREV_FILE			},
	{KEY_PLAYER_M6,				MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_NEXT_FILE			},
...
const ORDER_CFG ORDER_TAPE_KEY[]=
{
	//{KEY_RECORD_START,				MSG_MODE_UP_LESS_THAN,				MSG_REC_START		},
	//{KEY_RECORD_START,				MSG_MODE_DOWN_DELEY,				MSG_REC_STOP		},
	//{KEY_RECORD_PP,				MSG_MODE_UP_LESS_THAN,				MSG_REC_PP			},
