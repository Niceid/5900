...
#if defined(KEY_POWER_SEL)
#define KEY_SYSTEM_POWER_SEL												KEY_POWER_SEL
#endif
...
#define KEY_PLAYER_M0														KEY_VALUE_M0
...
#define KEY_PLAYER_M7														KEY_VALUE_M7
#define KEY_PLAYER_M8														KEY_VALUE_M8
#define KEY_PLAYER_M9														KEY_VALUE_M9
...
#define KEY_BT_PAUSE1														KEY_NAVI_UP
#define KEY_BT_PAUSE														KEY_VALUE_M1
#define KEY_BT_NEXT															KEY_VALUE_NEXT
#define KEY_BT_BACK															KEY_VALUE_PREV
#define KEY_BT_ANSWER														KEY_VALUE_PREV
#define KEY_BT_REJECT														KEY_VALUE_REJECT

#define KEY_BT_M0															KEY_VALUE_M0
#define KEY_BT_M1															KEY_VALUE_M1
#define KEY_BT_M2															KEY_VALUE_M2
#define KEY_BT_M3															KEY_VALUE_M3
#define KEY_BT_M4															KEY_VALUE_M4
#define KEY_BT_M5															KEY_VALUE_M5
#define KEY_BT_M6															KEY_VALUE_M6
#define KEY_BT_M7															KEY_VALUE_M7
#define KEY_BT_M8															KEY_VALUE_M8
#define KEY_BT_M9															KEY_VALUE_M9
#define KEY_BT_STAR															KEY_VALUE_NULL
#define KEY_BT_WELL															KEY_VALUE_NULL
#define KEY_BT_DEL															KEY_VALUE_NEXT
