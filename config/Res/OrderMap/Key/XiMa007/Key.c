...
const ORDER_CFG ORDER_SYSTEM_KEY[]=
{
	...
	{KEY_SYSTEM_MODE,			MSG_MODE_DOWN_DELEY,		MSG_SYS_SUB 				},
#else
	...
	{KEY_SYSTEM_POWER_SEL,		MSG_MODE_UP_LESS_THAN,		MSG_USER_SEL				},
	{KEY_SYSTEM_POWER_SEL,		MSG_MODE_DOWN_DELEY,		MSG_SYS_POWER				},
#endif	
	...
	{KEY_VALUE_M9,				MSG_MODE_DOWN_DELEY,		MSG_SYS_KEY_LIGHT			},
#endif
};
...
#if defined(_SPECIAL_SAVE_CH_)
	{KEY_OTHERS_SEL,			MSG_MODE_DOWN_DELEY,		MSG_FM_SLECT_UP 			},
	{KEY_OTHERS_ADD,			MSG_MODE_UP_LESS_THAN,		MSG_FM_SLECT_UP				},
	{KEY_OTHERS_SUB,			MSG_MODE_UP_LESS_THAN,		MSG_FM_SLECT_DOWN			},
...
#elif defined(_ENABLE_SAVE_FREQ_)
...
{
	{KEY_PLAYER_M1,				MSG_MODE_DOWN_DELEY,				MSG_MUSIC_RPT				},
	{KEY_PLAYER_M2,				MSG_MODE_DOWN_DELEY,				MSG_MUSIC_INT				},
	//{KEY_PLAYER_M3,				MSG_MODE_DOWN,				MSG_MUSIC_RPT				},
	{KEY_PLAYER_M4,				MSG_MODE_DOWN_DELEY,				MSG_MUSIC_SUB_10				},
	{KEY_PLAYER_M5,				MSG_MODE_DOWN_DELEY,				MSG_MUSIC_ADD_10		},
	...
	{KEY_PLAYER_M0,				MSG_MODE_UP_LESS_THAN,				MSG_MUSIC_0					},
	{KEY_PLAYER_M1,				MSG_MODE_UP_LESS_THAN,				MSG_MUSIC_1					},
	{KEY_PLAYER_M2,				MSG_MODE_UP_LESS_THAN,				MSG_MUSIC_2					},
	{KEY_PLAYER_M3,				MSG_MODE_UP_LESS_THAN,				MSG_MUSIC_3					},
	{KEY_PLAYER_M4,				MSG_MODE_UP_LESS_THAN,				MSG_MUSIC_4					},
	{KEY_PLAYER_M5,				MSG_MODE_UP_LESS_THAN,				MSG_MUSIC_5					},
 	{KEY_PLAYER_M6,				MSG_MODE_UP_LESS_THAN,				MSG_MUSIC_6					},
	//{KEY_PLAYER_M7, 			MSG_MODE_UP_LESS_THAN,				MSG_MUSIC_7					},
	//{KEY_PLAYER_M8, 			MSG_MODE_UP_LESS_THAN,				MSG_MUSIC_8					},
	{KEY_PLAYER_M9, 			MSG_MODE_UP_LESS_THAN,				MSG_MUSIC_9					},
...
const ORDER_CFG ORDER_BT_KEY[]=
{
	...
	{KEY_BT_ANSWER,				MSG_MODE_UP_LESS_THAN,		MSG_BT_ANSWER1					},
	{KEY_BT_REJECT,				MSG_MODE_UP_LESS_THAN,		MSG_BT_REJECT1					},
#endif
};	
...
const ORDER_CFG ORDER_BT_KEY_2NDF[]=
{
	...
	{KEY_BT_M0,					MSG_MODE_UP_LESS_THAN,			MSG_BT_0					},
	{KEY_BT_M1,					MSG_MODE_UP_LESS_THAN,			MSG_BT_1					},
	{KEY_BT_M2,					MSG_MODE_UP_LESS_THAN,			MSG_BT_2					},
	{KEY_BT_M3,					MSG_MODE_UP_LESS_THAN,			MSG_BT_3					},
	{KEY_BT_M4,					MSG_MODE_UP_LESS_THAN,			MSG_BT_4					},
	{KEY_BT_M5,					MSG_MODE_UP_LESS_THAN,			MSG_BT_5					},
	{KEY_BT_M6,					MSG_MODE_UP_LESS_THAN,			MSG_BT_6					},
	{KEY_BT_M7,					MSG_MODE_UP_LESS_THAN,			MSG_BT_7					},
	{KEY_BT_M8,					MSG_MODE_UP_LESS_THAN,			MSG_BT_8					},
	{KEY_BT_M9,					MSG_MODE_UP_LESS_THAN,			MSG_BT_9					},
	{KEY_BT_STAR,				MSG_MODE_UP_LESS_THAN,			MSG_BT_STAR					},
	{KEY_BT_WELL,				MSG_MODE_UP_LESS_THAN,			MSG_BT_WELL					},
    {KEY_BT_DEL,				MSG_MODE_DOWN_LOOP,				MSG_BT_DEL					},
};
...
const ORDER_CFG ORDER_OTHERS_KEY[]=
{
    ...
    {KEY_VALUE_M8,				MSG_MODE_UP_LESS_THAN,		MSG_CLOCK_SET3				},
    {KEY_VALUE_M8,				MSG_MODE_DOWN_DELEY,		MSG_CLOCK_SET3				},
#endif

#if defined(_XM007_MENU_SET_)
	{KEY_VALUE_M7,				MSG_MODE_UP_LESS_THAN,		MSG_USER_MENU				},
	{KEY_VALUE_M7,				MSG_MODE_DOWN_DELEY,		MSG_USER_MENU				},
#endif

#if defined(_XM007_BEEP_CONTROL)
	{KEY_VALUE_M1,				MSG_MODE_UP_LESS_THAN,		MSG_USER_M1				},
	{KEY_VALUE_M1,				MSG_MODE_DOWN_DELEY,		MSG_USER_M1				},
    {KEY_VALUE_M2,				MSG_MODE_UP_LESS_THAN,		MSG_USER_M2 			},
    {KEY_VALUE_M2,				MSG_MODE_DOWN_DELEY,		MSG_USER_M2 			},
    {KEY_VALUE_M3,				MSG_MODE_UP_LESS_THAN,		MSG_USER_M3 			},
    {KEY_VALUE_M3,				MSG_MODE_DOWN_DELEY,		MSG_USER_M3 			},
    {KEY_VALUE_M4,				MSG_MODE_UP_LESS_THAN,		MSG_USER_M4 			},
    {KEY_VALUE_M4,				MSG_MODE_DOWN_DELEY,		MSG_USER_M4 			},
    {KEY_VALUE_M5,				MSG_MODE_UP_LESS_THAN,		MSG_USER_M5 			},
    {KEY_VALUE_M5,				MSG_MODE_DOWN_DELEY,		MSG_USER_M5 			},
    {KEY_VALUE_M6,				MSG_MODE_UP_LESS_THAN,		MSG_USER_M6 			},
    {KEY_VALUE_M6,				MSG_MODE_DOWN_DELEY,		MSG_USER_M6 			},
    {KEY_VALUE_M9,				MSG_MODE_UP_LESS_THAN,		MSG_USER_M9 			},
    {KEY_VALUE_M9,				MSG_MODE_DOWN_DELEY,		MSG_USER_M9 			},
    {KEY_VALUE_M0,				MSG_MODE_UP_LESS_THAN,		MSG_USER_M0 			},
    {KEY_VALUE_M0,				MSG_MODE_DOWN_DELEY,		MSG_USER_M0 			},
    {KEY_VALUE_REJECT,			MSG_MODE_UP_LESS_THAN,		MSG_USER_REJECT 		},
    {KEY_VALUE_REJECT,			MSG_MODE_DOWN_DELEY,		MSG_USER_REJECT 		},
#endif
