...
const ORDER_CFG ORDER_RADIO_KEY[]=
{
	...
	{KEY_RADIO_NEXT1,			MSG_MODE_DOWN ,		        MSG_FM_NEXT_STEP1			},
	//{KEY_RADIO_NEXT1,			MSG_MODE_DOWN_DELEY,		MSG_FM_NEXT_STEP			},
	{KEY_RADIO_BACK1,			MSG_MODE_DOWN ,		        MSG_FM_PREV_STEP1			},
...
#if defined(MODE_REJECT_FUNCTION)
	{KEY_VALUE_MODE,			MSG_MODE_DOWN_DELEY,		MSG_BT_REDIAL				},
#else
