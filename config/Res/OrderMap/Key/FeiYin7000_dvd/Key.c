...
{/*********value********************mode************************order******/
	...
	{KEY_SYSTEM_DOOR,			MSG_MODE_UP_LESS_THAN,		MSG_SYS_EJECT 				},
#endif

#if defined(_CONNECT_BT_PHONE_)
#if defined(_SUPPORT_DISC_)
	{KEY_SYSTEM_EJECT,			MSG_MODE_DOWN_DELEY,		MSG_SYS_CONNECT				},
	{KEY_SYSTEM_DOOR,			MSG_MODE_DOWN_DELEY,		MSG_SYS_CONNECT				},
#endif
#endif
};
...
#if defined(_SYSTEM_CD_MODE_)
	{KEY_PLAYER_M5, 			MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_SUB_10			},
	{KEY_PLAYER_M6, 			MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_ADD_10			},
#else
	{KEY_PLAYER_M5, 			MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_FORMAT			},
	{KEY_PLAYER_M6, 			MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_CHANNEL			},
#endif
...
const ORDER_CFG ORDER_PLAYER_KEY_2NDF[]=
{
	...
	{KEY_PLAYER_ENTER, 			MSG_MODE_DOWN,				MSG_MUSIC_SEL 				},
