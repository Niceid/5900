...
#define KEY_SYSTEM_EJECT													KEY_VALUE_EJECT
#define KEY_SYSTEM_DOOR														KEY_VALUE_DOOR
...
#define KEY_RADIO_BAND														KEY_VALUE_BAND_AMS
#define KEY_RADIO_AMS														KEY_VALUE_BAND_AMS
...
#define KEY_PLAYER_M8														KEY_VALUE_BAND
#define KEY_PLAYER_M9														KEY_VALUE_NEXT
#define KEY_PLAYER_M0														KEY_VALUE_TIME

#define KEY_PLAYER_ADD														KEY_VALUE_ADD
#define KEY_PLAYER_SUB														KEY_VALUE_SUB
#define KEY_PLAYER_SEL														KEY_VALUE_SEL

#define KEY_PLAYER_NEXT														KEY_VALUE_NEXT
#define KEY_PLAYER_BACK														KEY_VALUE_PREV

//#define KEY_PLAYER_ID3													KEY_VALUE_AMS
#define KEY_PLAYER_SCH														KEY_VALUE_BAND_AMS
//#define KEY_PLAYER_FORMAT													KEY_VALUE_BAND_AMS
#define KEY_PLAYER_MP3JPGMP4												KEY_VALUE_BAND
#define KEY_PLAYER_AUDIO													KEY_VALUE_ST
...
#define KEY_BT_ANSWER														KEY_VALUE_BAND_AMS
#else

#define KEY_BT_PAUSE														KEY_VALUE_M1
#define KEY_BT_NEXT															KEY_VALUE_NEXT
#define KEY_BT_BACK															KEY_VALUE_PREV
#define KEY_BT_ANSWER														KEY_VALUE_NEXT
#define KEY_BT_REJECT														KEY_VALUE_PREV
#define KEY_BT_REDIAL														KEY_VALUE_BAND
#define KEY_BT_REDIAL1														KEY_VALUE_BAND_AMS
