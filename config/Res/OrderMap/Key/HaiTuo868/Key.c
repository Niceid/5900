...
const ORDER_CFG ORDER_SYSTEM_KEY[]=
{
	...
	{KEY_SYSTEM_DOOR,			MSG_MODE_DOWN,				MSG_SYS_EJECT				},
...
//	{KEY_PLAYER_ID3,			MSG_MODE_DOWN_DELEY,		MSG_MUSIC_ID3				},
	{KEY_PLAYER_SCH,			MSG_MODE_DOWN_DELEY ,		MSG_MUSIC_SEARCH			},
		
	{KEY_PLAYER_SCH,			MSG_MODE_UP_LESS_THAN ,		MSG_MUSIC_MP3_JPG_MP4		},
	//{KEY_PLAYER_MP3JPGMP4,		MSG_MODE_UP_LESS_THAN ,		MSG_MUSIC_MP3_JPG_MP4		},
//	{KEY_PLAYER_FORMAT,			MSG_MODE_DOWN_DELEY ,		MSG_MUSIC_FORMAT			},
		
	{KEY_PLAYER_AUDIO,			MSG_MODE_DOWN,				MSG_MUSIC_CHANNEL			},
};
...
const ORDER_CFG ORDER_PLAYER_KEY_2NDF[]=
{
	...
	{KEY_PLAYER_SEL, 			MSG_MODE_DOWN,				MSG_MUSIC_SEL 				},
...
//       {KEY_BT_REDIAL1,			MSG_MODE_DOWN,				MSG_BT_REDIAL				},
};
#if 0
{
	{KEY_BT_PAUSE,				MSG_MODE_DOWN,				MSG_BT_PP					},
