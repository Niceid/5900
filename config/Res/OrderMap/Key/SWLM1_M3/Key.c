...
#if defined(_RETOME_KEY_SPECIAL_FUNCTION_)
    {KEY_VALUE_NAVI_UP,			MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_PLAY_MODE		    },
	{KEY_VALUE_NAVI_UP, 		MSG_MODE_DOWN_DELEY,		MSG_MUSIC_NEXT_FOLDER		},
	{KEY_VALUE_NAVI_DOWN,		MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_PP 		        },
