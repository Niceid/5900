...
{/*********value********************mode************************order******/
	...
	{KEY_PLAYER_BT,			    MSG_MODE_UP_LESS_THAN,				MSG_SYS_BT				},
	{KEY_PLAYER_BT,				MSG_MODE_DOWN_DELEY,				MSG_SYS_SIR				},
#endif

#if defined(_CHANGE_DISP_MODE_)
    {KEY_VALUE_CHANGE,          MSG_MODE_DOWN,              MSG_SYS_CHANGE1                },
    {KEY_VALUE_CHANGE1,			MSG_MODE_DOWN,				MSG_SYS_CHANGE1				  },
#endif
