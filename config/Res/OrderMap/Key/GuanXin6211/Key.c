...
{/*********value********************mode************************order******/
	...
	{KEY_SYSTEM_POWER_COLOR,	MSG_MODE_UP_LESS_THAN,		MSG_SYS_LIGHT				},
	{KEY_SYSTEM_POWER_COLOR,	MSG_MODE_DOWN_DELEY,		MSG_SYS_POWER				},
#else
	...
	{KEY_SYSTEM_MODE, 			MSG_MODE_DOWN_DELEY,		MSG_SYS_CONNECT 			},
#endif
	...
	{KEY_SYSTEM_EJECT,			MSG_MODE_DOWN_DELEY,		MSG_SYS_EJECT1 				},
#endif
};
