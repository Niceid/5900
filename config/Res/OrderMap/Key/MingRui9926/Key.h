...
#define KEY_SYSTEM_AF														KEY_VALUE_AF
#define KEY_SYSTEM_TA														KEY_VALUE_AF
#endif
#define KEY_SYSTEM_PTY														KEY_VALUE_PTY
...
#define KEY_RDS_PTY															KEY_VALUE_PTY
...
#define KEY_PLAYER_NEXT														KEY_VALUE_M2//KEY_VALUE_NEXT
#define KEY_PLAYER_BACK														KEY_VALUE_M1//KEY_VALUE_PREV
#define KEY_PLAYER_ID3														KEY_VALUE_BAND
#define KEY_PLAYER_SCH														KEY_VALUE_AMS
#define KEY_PLAYER_ID3_SCH													KEY_VALUE_BAND_AMS
#define KEY_PLAYER_PLAY													    KEY_VALUE_BAND_AMS
...
#define KEY_BT_NEXT															KEY_VALUE_M2
#define KEY_BT_BACK															KEY_VALUE_M1

#if defined(MR9926_CHANGE_ANSWER_REJECT_)
#define KEY_BT_ANSWER														KEY_VALUE_AF
#define KEY_BT_REJECT														KEY_VALUE_PTY
#else
#define KEY_BT_ANSWER														KEY_VALUE_M2
#define KEY_BT_REJECT														KEY_VALUE_M1
#define KEY_BT_ANSWER2														KEY_VALUE_NULL
#endif

#if defined(_SUPPORT_IPHONE_SIR_)
#define KEY_BT_SIR															KEY_VALUE_M3
#endif
