...
#define KEY_SYSTEM_POWER_COLOR												KEY_POWER_COLOR
#endif
...
#define KEY_PLAYER_PLAY														KEY_VALUE_PLAY
#define KEY_PLAYER_STOP														KEY_VALUE_STOP
#define KEY_PLAYER_RPT														KEY_VALUE_RPT

/*---------------------------------------------------------------------------------------------------
	蓝牙
*---------------------------------------------------------------------------------------------------*/

#define KEY_BT_PAUSE1														KEY_VALUE_PLAY
