...
{/*********value********************mode************************order******/
    ...
    {KEY_VALUE_ANSWER,			MSG_MODE_UP_LESS_THAN,		MSG_SYS_ANSWER_MODE			},
    {KEY_VALUE_ANSWER,			MSG_MODE_DOWN_DELEY,		MSG_SYS_ANSWER_MODE			},	

	{KEY_VALUE_REJECT,			MSG_MODE_UP_LESS_THAN,		MSG_SYS_BAND_BT				},
    {KEY_VALUE_REJECT,			MSG_MODE_DOWN_DELEY,		MSG_SYS_BAND_BT				},	
#endif
};
...
#if defined(SUPPORT_PARTY_CONTROL)
    {KEY_VALUE_NEXT1, 			MSG_MODE_UP_LESS_THAN , 	MSG_FM_SLECT_UP 			},	
    {KEY_VALUE_NEXT1, 			MSG_MODE_DOWN_DELEY,		MSG_FM_NEXT_SEEK			},
    {KEY_VALUE_PREV1, 			MSG_MODE_UP_LESS_THAN , 	MSG_FM_SLECT_DOWN			},
    {KEY_VALUE_PREV1, 			MSG_MODE_DOWN_DELEY,		MSG_FM_PREV_SEEK			},
#endif
...
const ORDER_CFG ORDER_PLAYER_KEY[]=
{
	...
	{KEY_PLAYER_M4,				MSG_MODE_DOWN,				MSG_MUSIC_RPT				},
	{KEY_PLAYER_M5,				MSG_MODE_DOWN,				MSG_MUSIC_RDM				},

	{KEY_PLAYER_M3, 			MSG_MODE_DOWN_DELEY,		MSG_MUSIC_SUB_10			},
	{KEY_PLAYER_M3,				MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_PREV_FOLDER		},
...
#if defined(SUPPORT_PARTY_CONTROL)
    {KEY_VALUE_ANSWER1, 		MSG_MODE_DOWN,				MSG_BT_ANSWER_CALL			},
    {KEY_VALUE_REJECT1, 		MSG_MODE_DOWN,				MSG_BT_CALL_REJECT			},
#endif
};	
...
const ORDER_CFG ORDER_OTHERS_KEY[]=
{
	...
	{KEY_VALUE_AMS,				MSG_MODE_DOWN_DELEY,		MSG_SYS_RESET_VIEW			},
#endif
};
