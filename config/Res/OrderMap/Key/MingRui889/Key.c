...
#if defined(_MR889_SPECAIL_KEY_)
	{KEY_RADIO_NEXT,			MSG_MODE_UP_LESS_THAN ,		MSG_FM_SLECT_UP1			},	
	{KEY_RADIO_NEXT,			MSG_MODE_DOWN_DELEY,		MSG_FM_SLECT_UP1			},
	{KEY_RADIO_BACK,			MSG_MODE_UP_LESS_THAN ,		MSG_FM_SLECT_DOWN1			},
	{KEY_RADIO_BACK,			MSG_MODE_DOWN_DELEY,		MSG_FM_SLECT_DOWN1			},
#else
...
{
#if defined(_MR889_CHANGE_KEY_FUNCTION_)
#if defined(_DISABLE_EQ_FUNCTION_)
    {KEY_BT_PAUSE1, 			MSG_MODE_DOWN,				MSG_BT_PP					},
#else
    {KEY_BT_PAUSE1, 			MSG_MODE_DOWN_DELEY,		MSG_BT_PP					},
#endif    
#else
	{KEY_BT_PAUSE1,				MSG_MODE_DOWN,				MSG_BT_PP					},
#endif	
...
#if defined(_MR889_CHANGE_ANSWER_REJECT_)
    {KEY_BT_ANSWER,				MSG_MODE_UP_LESS_THAN,		MSG_BT_ANSWER_CALL2			},
	{KEY_BT_REJECT,				MSG_MODE_UP_LESS_THAN,		MSG_BT_CALL_REJECT2			},
...
#if defined(_MR889_CHANGE_KEY_FUNCTION_)
#if defined(_DISABLE_EQ_FUNCTION_)
	{KEY_OTHERS_EQ,				MSG_MODE_DOWN,		        MSG_MUSIC_PP				},
#else
    {KEY_OTHERS_EQ, 			MSG_MODE_UP_LESS_THAN,		MSG_AUD_EQ					},
	{KEY_OTHERS_EQ,				MSG_MODE_DOWN_DELEY,		MSG_MUSIC_PP				},
#endif	
#else
