...
#define KEY_SYSTEM_AF_TA													KEY_VALUE_TIME_MUTE
#endif
...
#define KEY_RDS_PTY															KEY_VALUE_LOUD
...
#define KEY_CONNECT_BT_PHONE_                                               KEY_VALUE_BAND_AMS
#endif
...
#if defined(_ENABLE_RADIO_RDS_)
#define KEY_OTHERS_TIME_MUTE 												KEY_VALUE_NULL
#else
