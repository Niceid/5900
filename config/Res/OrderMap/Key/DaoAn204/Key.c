...
{/*********value********************mode************************order******/
	...
	{KEY_VALUE_PLAY_TIME,		MSG_MODE_UP_LESS_THAN,		MSG_PLAY_TIME				},
	{KEY_VALUE_PLAY_TIME,		MSG_MODE_DOWN_DELEY,		MSG_PLAY_TIME				},
#endif
...
#if defined(_DA_SPECIAL_KEY_FUNCTION_)
    {KEY_PLAYER_NEXT,			MSG_MODE_DOWN_DELEY,		MSG_MUSIC_ADD_10			},
#else
...
#if defined(_DA_SPECIAL_KEY_FUNCTION_)
    {KEY_PLAYER_BACK,			MSG_MODE_DOWN_DELEY,		MSG_MUSIC_SUB_10			},
#else
	{KEY_PLAYER_BACK,			MSG_MODE_DELEY_LOOP,		MSG_MUSIC_FR				},
	{KEY_PLAYER_BACK,			MSG_MODE_UP_MORE_THAN,		MSG_MUSIC_FFR_DONE			},
#endif

#if defined(_ENABLE_BAND_KEY_PLAY_MODE_)
	{KEY_PLAYER_ID3,			MSG_MODE_DOWN,				MSG_MUSIC_PLAY_MODE			},
#elif defined(_ENABLE_BAND_KEY_MODE_)
	{KEY_PLAYER_ID3,			MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_PP 				},
	{KEY_PLAYER_ID3,			MSG_MODE_DOWN_DELEY,		MSG_MUSIC_PLAY_MODE 		},
#else
...
#else
#if defined(_ENABLE_BAND_AMS_KEY_PLAY_MODE_)
	{KEY_PLAYER_ID3_SCH,		MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_PLAY_MODE			},
#else
