...
const ORDER_CFG ORDER_PLAYER_KEY[]=
{
	...
	{KEY_PLAYER_M2,				MSG_MODE_DOWN,				MSG_MUSIC_RPT				},
...
const ORDER_CFG ORDER_BT_KEY[]=
{
    ...
    {KEY_BT_REDIAL2, 			MSG_MODE_DOWN_DELEY,		MSG_BT_REDIAL				},
    {KEY_BT_REJECT, 			MSG_MODE_UP_LESS_THAN,		MSG_BT_CALL_REJECT			},
    {KEY_BT_REJECT2, 			MSG_MODE_UP_LESS_THAN,		MSG_BT_CALL_REJECT			},
    
#if defined(_GX9006_CHANGE_KEYMAP_)
    {KEY_BT_REJECT2, 			MSG_MODE_DOWN_DELEY,		MSG_BT_CONNECT_CTL			},
#endif
...
#endif
#if !defined(_ENABLE_SET_COLOR_)
#if defined(_GX_CHANGE_KEY_FUNCTION_)
    {KEY_OTHERS_EQ_LOUD,		MSG_MODE_DOWN_DELEY,		MSG_AUD_EQ					},
	{KEY_OTHERS_EQ_LOUD,		MSG_MODE_UP_LESS_THAN,		MSG_AUD_LOUD				},
#else
