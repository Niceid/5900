...
#elif defined(_GX9006_CHANGE_KEYMAP_)
#define KEY_BT_ANSWER														KEY_RESPONSE_NULL
#define KEY_BT_ANSWER_2														KEY_RESPONSE_NULL
#define KEY_BT_REJECT														KEY_VALUE_BAND
#define KEY_BT_REJECT2														KEY_VALUE_BAND_AMS
#define KEY_BT_REDIAL														KEY_VALUE_MODE
#define KEY_BT_REDIAL2														KEY_VALUE_M5
#else
...
#define KEY_BT_ANSWER_CHANGE                                                 KEY_VALUE_M2
#endif

#if defined(_GX9006_CHANGE_KEYMAP_)
#define KEY_CONNECT_BT_PHONE_                                                 KEY_VALUE_M6
#endif
