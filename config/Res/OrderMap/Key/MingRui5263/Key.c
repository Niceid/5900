...
const ORDER_CFG ORDER_PLAYER_KEY[]=
{
    ...
    {KEY_VALUE_DIR_UP, 		    MSG_MODE_DOWN,		        MSG_MUSIC_NEXT_FOLDER		},
	{KEY_VALUE_DIR_DOWN,		MSG_MODE_DOWN,		        MSG_MUSIC_PREV_FOLDER		},
...
const ORDER_CFG ORDER_OTHERS_KEY[]=
{
	...
	{KEY_OTHERS_SEL,			MSG_MODE_UP_LESS_THAN,		MSG_SEL_CLK				},
	{KEY_OTHERS_SEL,			MSG_MODE_DOWN_DELEY,		MSG_SEL_CLK				},
#else
	...
	{KEY_VALUE_SIRI,			MSG_MODE_DOWN,				 MSG_SYS_SIR 			},
#endif
