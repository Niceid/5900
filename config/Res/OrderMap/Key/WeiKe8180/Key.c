...
const ORDER_CFG ORDER_SYSTEM_KEY[]=
{
	...
	//{KEY_SYSTEM_AF,				MSG_MODE_DOWN_DELEY,		MSG_RDS_TA					},
#endif
...
const ORDER_CFG ORDER_PLAYER_KEY[]=
{
...
#if defined(_ENABLE_KEY_NUMBER_)
	...
	{KEY_PLAYER_NAVI_UP,		MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_PP				},
	{KEY_PLAYER_NAVI_UP,		MSG_MODE_DOWN_DELEY,		MSG_MUSIC_NEXT_FOLDER		},

	{KEY_PLAYER_NAVI_DOWN,		MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_PLAY_MODE			},
	{KEY_PLAYER_NAVI_DOWN,		MSG_MODE_DOWN_DELEY,		MSG_MUSIC_PREV_FOLDER		},
};
