...
{/*********value********************mode************************order******/
	...
	{KEY_SYSTEM_AF,				MSG_MODE_UP_LESS_THAN,		MSG_RDS_AF_REG				},
	{KEY_SYSTEM_AF,				MSG_MODE_DOWN_DELEY,		MSG_RDS_AF_REG				},
#else
...
#if defined(_RDS_KEY_FUNTION_)
	{KEY_SYSTEM_TA,				MSG_MODE_UP_LESS_THAN,		MSG_RDS_TA_EON				},
	{KEY_SYSTEM_TA,				MSG_MODE_DOWN_DELEY,		MSG_RDS_TA_EON				},
#else
...
#if !defined(_DISABLE_RECORD_KEY_)
...
#else
	{KEY_RADIO_AMS, 			MSG_MODE_UP_LESS_THAN,		MSG_FM_AUTO_SAVE			},
	{KEY_RADIO_AMS, 			MSG_MODE_DOWN_DELEY,		MSG_FM_BROWSE				},
#endif
...
#if defined(_FY700B_PARTY_CONTROL_)
	{KEY_PLAYER_ID3_SCH1,		MSG_MODE_DOWN,				MSG_MUSIC_SEARCH			},
	{KEY_PLAYER_SCH1,			MSG_MODE_DOWN,				MSG_MUSIC_SEARCH			},
...
#if defined(_FY700B_PARTY_CONTROL_)
#if defined(_ENABLE_KEY_REDIAL_)
	{KEY_BT_ANSWER_3,			MSG_MODE_DOWN,				MSG_BT_ANSWER_REDIAL		},
#else
	{KEY_BT_ANSWER_3, 			MSG_MODE_DOWN,				MSG_BT_ANSWER_CALL			},
#endif
