...
{/*********value********************mode************************order******/
	...
	{KEY_SYSTEM_BAND_AMS,		MSG_MODE_UP_LESS_THAN,		MSG_SYS_RADIO				},
	{KEY_SYSTEM_BAND_AMS,		MSG_MODE_DOWN_DELEY,		MSG_SYS_RADIO				},
#endif
...
const ORDER_CFG ORDER_RADIO_KEY[]=
{
	...
	{KEY_RADIO_NEXT,			MSG_MODE_UP_LESS_THAN ,		MSG_FM_SLECT_UP			},	
	{KEY_RADIO_NEXT,			MSG_MODE_DOWN_DELEY,		MSG_FM_NEXT_SEEK			},
	{KEY_RADIO_BACK,			MSG_MODE_UP_LESS_THAN ,		MSG_FM_SLECT_DOWN			},
...
const ORDER_CFG ORDER_PLAYER_KEY[]=
{
	...
	{KEY_PLAYER_M2,				MSG_MODE_DOWN_DELEY,				MSG_MUSIC_RDM		},
...
const ORDER_CFG ORDER_BT_KEY[]=
{
	...
	{KEY_BT_ANSWER_CHANGE,		MSG_MODE_DOWN,				MSG_BT_VOL_CHANGE			},
#endif
};	
...
const ORDER_CFG ORDER_OTHERS_KEY[]=
{
	...
	{KEY_OTHERS_SEL,			MSG_MODE_UP_LESS_THAN,		MSG_CLOCK_SET1				},
	{KEY_OTHERS_SEL,			MSG_MODE_DOWN_DELEY,		MSG_CLOCK_SET1				},
#else
