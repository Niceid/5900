...
const ORDER_CFG ORDER_BT_KEY[]=
{
	...
	{KEY_BT_ANSWER,				MSG_MODE_UP_LESS_THAN,		MSG_BT_ANSWER_CALL3			},
	{KEY_BT_REJECT,				MSG_MODE_UP_LESS_THAN,		MSG_BT_CALL_REJECT3			},
	{KEY_BT_ANSWER,				MSG_MODE_DOWN_DELEY,		MSG_BT_REDIAL				},
	{KEY_BT_ANSWER1,			MSG_MODE_DOWN,		        MSG_BT_ANSWER_CALL			},
	{KEY_BT_REJECT1, 			MSG_MODE_UP_LESS_THAN,		MSG_BT_CALL_REJECT 		    },
	//{KEY_BT_ANSWER1,			MSG_MODE_DOWN,		        MSG_BT_REDIAL	            },
