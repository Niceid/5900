...
const ORDER_CFG ORDER_SYSTEM_KEY[]=
{
	...
	{KEY_SYSTEM_POWER_MUTE1,	MSG_MODE_UP_LESS_THAN,		MSG_SYS_MUTE				},
	{KEY_SYSTEM_POWER_MUTE1,	MSG_MODE_DOWN_DELEY,		MSG_SYS_POWER				},
#endif
    ...
    {KEY_OTHERS_TIME_EQ,		MSG_MODE_UP_LESS_THAN,		MSG_CLOCK_EQ				},
    {KEY_OTHERS_TIME_EQ,		MSG_MODE_DOWN_DELEY,		MSG_CLOCK_EQ				},
#endif
};
...
const ORDER_CFG ORDER_PLAYER_KEY[]=
{
	...
	{KEY_PLAYER_M3,				MSG_MODE_DOWN_DELEY,		MSG_MUSIC_RDM				},
...
const ORDER_CFG ORDER_BT_KEY[]=
{
	...
	{KEY_BT_ANSWER, 			MSG_MODE_UP_LESS_THAN,		MSG_BT_ANSWER_CALL2			},
	{KEY_BT_REJECT, 			MSG_MODE_DOWN,				MSG_BT_CALL_REJECT2			},
