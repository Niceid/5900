...
{/*********value********************mode************************order******/
	...
	{KEY_SYSTEM_POWER1,			MSG_MODE_DOWN,				MSG_SYS_POWER				},
...
#if defined(SUPPORT_PARTY_CONTROL)
#if defined(_ENABLE_SAVE_FREQ_)
	{KEY_RADIO_NAVI_UP1, 		MSG_MODE_UP_LESS_THAN,		MSG_FM_SLECT_UP 			},
	{KEY_RADIO_NAVI_UP1, 		MSG_MODE_DOWN_DELEY,		MSG_FM_NEXT_SEEK 			},
	{KEY_RADIO_NAVI_DOWN1,		MSG_MODE_UP_LESS_THAN,		MSG_FM_SLECT_DOWN			},
	{KEY_RADIO_NAVI_DOWN1,		MSG_MODE_DOWN_DELEY,		MSG_FM_PREV_SEEK			},
#endif
#endif
...
#if defined(SUPPORT_PARTY_CONTROL)
	{KEY_VALUE_NAVI_UP1,		MSG_MODE_DOWN,				MSG_MUSIC_NEXT_FILE			},
	{KEY_VALUE_NAVI_DOWN1,		MSG_MODE_DOWN,				MSG_MUSIC_PREV_FILE 		},
#endif
};
...
const ORDER_CFG ORDER_BT_KEY[]=
{
	...
	{KEY_BT_REJECT1,			MSG_MODE_DOWN,				MSG_BT_CALL_REJECT			},
#endif
};	
