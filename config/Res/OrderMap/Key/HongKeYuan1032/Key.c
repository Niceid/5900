...
{/*********value********************mode************************order******/
	...
	{KEY_SYSTEM_MODE, 			MSG_MODE_DOWN_DELEY,		MSG_SYS_VERSION				},
#endif
	...
	{KEY_VALUE_TEMP,			MSG_MODE_UP_LESS_THAN,		MSG_SYS_TEMP				},
	{KEY_VALUE_WARM,			MSG_MODE_UP_LESS_THAN,		MSG_SYS_WARM				},
	{KEY_VALUE_WARM_POWER,	    MSG_MODE_UP_LESS_THAN,		MSG_SYS_WARM_POWER			},
#endif
};
