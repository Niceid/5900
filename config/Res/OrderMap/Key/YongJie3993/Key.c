...
{/*********value********************mode************************order******/
	...
	{KEY_SYSTEM_POWER,			MSG_MODE_DOWN_DELEY,		MSG_ADJ_CONTROL_SPK 		},
#else
...
const ORDER_CFG ORDER_RADIO_KEY[]=
{
	...
	{KEY_RADIO_NEXT,			MSG_MODE_UP_LESS_THAN , 	MSG_FM_NEXT_STEP			},	
	{KEY_RADIO_NEXT,			MSG_MODE_DOWN_DELEY,		MSG_FM_NEXT_SEEK			},
	{KEY_RADIO_BACK,			MSG_MODE_UP_LESS_THAN , 	MSG_FM_PREV_STEP			},
	{KEY_RADIO_BACK,			MSG_MODE_DOWN_DELEY,		MSG_FM_PREV_SEEK			},
#else
    ...
    {KEY_VALUE_NEXT1,			MSG_MODE_UP_LESS_THAN , 	MSG_FM_NEXT_SEEK			},	
    {KEY_VALUE_NEXT1,			MSG_MODE_DOWN_DELEY,		MSG_FM_NEXT_STEP			},
    {KEY_VALUE_PREV1,			MSG_MODE_UP_LESS_THAN , 	MSG_FM_PREV_SEEK			},
    {KEY_VALUE_PREV1,			MSG_MODE_DOWN_DELEY,		MSG_FM_PREV_STEP			},

    {KEY_VALUE_NEXT2,			MSG_MODE_UP_LESS_THAN , 	MSG_FM_NEXT_SEEK			},	
    {KEY_VALUE_NEXT2,			MSG_MODE_DOWN_DELEY,		MSG_FM_NEXT_STEP			},
    {KEY_VALUE_PREV2,			MSG_MODE_UP_LESS_THAN , 	MSG_FM_PREV_SEEK			},
    {KEY_VALUE_PREV2,			MSG_MODE_DOWN_DELEY,		MSG_FM_PREV_STEP			},
#endif
...
const ORDER_CFG ORDER_PLAYER_KEY[]=
{
    ...
    {KEY_VALUE_NEXT1,			MSG_MODE_DELEY_LOOP,		MSG_MUSIC_FF				},
    {KEY_VALUE_NEXT1,			MSG_MODE_UP_MORE_THAN,		MSG_MUSIC_FFR_DONE			},
    {KEY_VALUE_PREV1,			MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_PREV_FILE 		},
    {KEY_VALUE_PREV1,			MSG_MODE_DELEY_LOOP,		MSG_MUSIC_FR				},
    {KEY_VALUE_PREV1,			MSG_MODE_UP_MORE_THAN,		MSG_MUSIC_FFR_DONE			},

    {KEY_VALUE_NEXT2,			MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_NEXT_FILE 		},
    {KEY_VALUE_NEXT2,			MSG_MODE_DELEY_LOOP,		MSG_MUSIC_FF				},
    {KEY_VALUE_NEXT2,			MSG_MODE_UP_MORE_THAN,		MSG_MUSIC_FFR_DONE			},
    {KEY_VALUE_PREV2,			MSG_MODE_UP_LESS_THAN,		MSG_MUSIC_PREV_FILE 		},
    {KEY_VALUE_PREV2,			MSG_MODE_DELEY_LOOP,		MSG_MUSIC_FR				},
    {KEY_VALUE_PREV2,			MSG_MODE_UP_MORE_THAN,		MSG_MUSIC_FFR_DONE			},
#endif

	{KEY_PLAYER_ID3,			MSG_MODE_DOWN,				MSG_MUSIC_ID3				},
	{KEY_PLAYER_SCH,			MSG_MODE_DOWN,				MSG_MUSIC_SEARCH			},

#if !defined(_DISABLE_PLAY_KEY_FUNC_)
...
#if defined(_YJ3993_ADKEY_CONTROL_)
    {KEY_VALUE_ADD1,			MSG_MODE_DOWN,				MSG_MUSIC_ADD				},
    {KEY_VALUE_SUB1,			MSG_MODE_DOWN,				MSG_MUSIC_SUB				},
    {KEY_VALUE_ADD2,			MSG_MODE_DOWN,				MSG_MUSIC_ADD				},
    {KEY_VALUE_SUB2,			MSG_MODE_DOWN,				MSG_MUSIC_SUB				},
#endif
...
{
#if defined(_YJ3993_ADKEY_CONTROL_)
	{KEY_VALUE_ANSWER1, 		MSG_MODE_UP_LESS_THAN,		MSG_BT_ANSWER_REJECT		},
	{KEY_VALUE_ANSWER2, 		MSG_MODE_UP_LESS_THAN,		MSG_BT_ANSWER_REJECT		},
	{KEY_VALUE_NEXT1,			MSG_MODE_DOWN,				MSG_BT_NEXT_FILE			},
	{KEY_VALUE_PREV1,			MSG_MODE_DOWN,				MSG_BT_PREV_FILE			},
	{KEY_VALUE_NEXT2,			MSG_MODE_DOWN,				MSG_BT_NEXT_FILE			},
	{KEY_VALUE_PREV2,			MSG_MODE_DOWN,				MSG_BT_PREV_FILE			},
#endif
...
#if defined(_YJ3993_ADKEY_CONTROL_)
	{KEY_VALUE_MUTE1,           MSG_MODE_DOWN,      		MSG_SYS_MUTE                },
	{KEY_VALUE_MUTE2,           MSG_MODE_DOWN,      		MSG_SYS_MUTE                },
    {KEY_VALUE_ADD1,			MSG_MODE_DOWN_LOOP,			MSG_VOL_ADD					},
    {KEY_VALUE_SUB1,			MSG_MODE_DOWN_LOOP,			MSG_VOL_SUB					},
    {KEY_VALUE_ADD2,			MSG_MODE_DOWN_LOOP,			MSG_VOL_ADD					},
    {KEY_VALUE_SUB2,			MSG_MODE_DOWN_LOOP,			MSG_VOL_SUB					},
#endif
};
