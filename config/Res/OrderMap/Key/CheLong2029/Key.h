...
#define KEY_RADIO_NEXT														KEY_VALUE_ADD1
#define KEY_RADIO_BACK														KEY_VALUE_SUB1
#if defined(_ENABLE_RADIO_RDS_)
...
#define KEY_PLAYER_ADD														KEY_VALUE_ADD1
#define KEY_PLAYER_SUB														KEY_VALUE_SUB1
#define KEY_PLAYER_ENTER													KEY_VALUE_SEL

#define KEY_PLAYER_NEXT														KEY_VALUE_ADD1
#define KEY_PLAYER_BACK														KEY_VALUE_SUB1
...
#define KEY_BT_NEXT															KEY_VALUE_ADD1
#define KEY_BT_BACK															KEY_VALUE_SUB1
#if defined(_XDXF_SPECIAL_ANSWER_REJECT_)
#define KEY_BT_ANSWER														KEY_VALUE_MUTE
#define KEY_BT_ANSWER_2														KEY_RESPONSE_NULL
#define KEY_BT_REJECT														KEY_VALUE_POWER
#elif defined(_HYX_SPECIAL_ANSWER_REJECT_)
#define KEY_BT_ANSWER														KEY_VALUE_BAND_AMS
#define KEY_BT_ANSWER_2														KEY_VALUE_BAND
#define KEY_BT_REJECT														KEY_RESPONSE_NULL
#elif defined(_HZS_BAND_REJECT_)
#define KEY_BT_ANSWER														KEY_RESPONSE_NULL
#define KEY_BT_ANSWER_2														KEY_RESPONSE_NULL
#define KEY_BT_REJECT														KEY_VALUE_BAND_AMS
#else
...
#define KEY_OTHERS_ADD														KEY_VALUE_ADD1
#define KEY_OTHERS_SUB														KEY_VALUE_SUB1
