...
{/*********value********************mode************************order******/
    ...
    {KEY_OTHERS_ADD,			MSG_MODE_UP_LESS_THAN,		MSG_VOL_ADD1					},
	{KEY_OTHERS_SUB,			MSG_MODE_UP_LESS_THAN,		MSG_VOL_SUB1					},
	{KEY_OTHERS_ADD,			MSG_MODE_DELEY_LOOP,		MSG_VOL_ADD1					},
	{KEY_OTHERS_SUB,			MSG_MODE_DELEY_LOOP,		MSG_VOL_SUB1					},
#endif
};
