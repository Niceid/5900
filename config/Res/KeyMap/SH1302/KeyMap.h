...
#define ADC1_KEY9_TEST_VALUE				KEY_ADC_VALUE(35)
#define ADC1_KEY10_TEST_VALUE				KEY_ADC_VALUE(42)
#define ADC1_KEY11_TEST_VALUE				KEY_ADC_VALUE(47)
#define ADC1_KEY12_TEST_VALUE				KEY_ADC_VALUE(52)
...
/*---------------------------------------------*/
	...
	KEY_VALUE_PREV,
	KEY_VALUE_BAND,
#if defined(_ENABLE_KEY_RDS_FUNC_)
    KEY_VALUE_PTY,
    KEY_VALUE_AF_TA,
#else
	KEY_VALUE_AMS,
