...
#if defined(_ZLH_PARTY_CONTROL_KEY_VALUE_)
#define ADC3_KEY1_TEST_VALUE				KEY_ADC_VALUE(0)
#define ADC3_KEY2_TEST_VALUE				KEY_ADC_VALUE(20)
#define ADC3_KEY3_TEST_VALUE				KEY_ADC_VALUE(26)
#define ADC3_KEY4_TEST_VALUE				KEY_ADC_VALUE(30)
#define ADC3_KEY5_TEST_VALUE				KEY_ADC_VALUE(35)
#define ADC3_KEY6_TEST_VALUE				KEY_ADC_VALUE(40)
#define ADC3_KEY7_TEST_VALUE				KEY_ADC_VALUE(46)
...
#define ADC3_KEY3_TEST_VALUE				KEY_ADC_VALUE(26)
#define ADC3_KEY4_TEST_VALUE				KEY_ADC_VALUE(30)
#define ADC3_KEY5_TEST_VALUE				KEY_ADC_VALUE(34)
#define ADC3_KEY6_TEST_VALUE				KEY_ADC_VALUE(40)
#define ADC3_KEY7_TEST_VALUE				KEY_ADC_VALUE(45)
#define ADC3_KEY8_TEST_VALUE				KEY_ADC_VALUE(51)
#endif
#endif
