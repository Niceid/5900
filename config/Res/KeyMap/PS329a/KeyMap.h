...
#if defined(_PS_CHANGE_PARTY_CONTROL_KEYMAP_)
#define ADC3_KEY1_TEST_VALUE				KEY_ADC_VALUE(10)
#define ADC3_KEY2_TEST_VALUE				KEY_ADC_VALUE(16)
#define ADC3_KEY3_TEST_VALUE				KEY_ADC_VALUE(18)
#define ADC3_KEY4_TEST_VALUE				KEY_ADC_VALUE(20)
#define ADC3_KEY5_TEST_VALUE				KEY_ADC_VALUE(23)
#define ADC3_KEY6_TEST_VALUE				KEY_ADC_VALUE(31)
#else
#define ADC3_KEY1_TEST_VALUE				KEY_ADC_VALUE(10)
#define ADC3_KEY2_TEST_VALUE				KEY_ADC_VALUE(16)
#define ADC3_KEY3_TEST_VALUE				KEY_ADC_VALUE(22)
#define ADC3_KEY4_TEST_VALUE				KEY_ADC_VALUE(29)
#define ADC3_KEY5_TEST_VALUE				KEY_ADC_VALUE(35)
#define ADC3_KEY6_TEST_VALUE				KEY_ADC_VALUE(42)
#endif
#else
#define ADC3_KEY1_TEST_VALUE				KEY_ADC_VALUE(0)
#define ADC3_KEY2_TEST_VALUE				KEY_ADC_VALUE(8)
#define ADC3_KEY3_TEST_VALUE				KEY_ADC_VALUE(16)
#define ADC3_KEY4_TEST_VALUE				KEY_ADC_VALUE(24)
#define ADC3_KEY5_TEST_VALUE				KEY_ADC_VALUE(32)
#define ADC3_KEY6_TEST_VALUE				KEY_ADC_VALUE(41)
#endif
#endif
