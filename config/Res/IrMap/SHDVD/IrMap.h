...
#define IR_CODE_MUTE			0x45
#define IR_CODE_PLAY 			0x46
#define IR_CODE_POWER			0x47

#define IR_CODE_MODE 			0x44
#define IR_CODE_ADD_VOL			0x40
#define IR_CODE_TITLE			0x43

#define IR_CODE_BACK			0x07
#define IR_CODE_SEL				0x15
#define IR_CODE_NEXT			0x09

#define IR_CODE_AMS 			0x16
#define IR_CODE_SUB_VOL			0x19
#define IR_CODE_BAND			0x0D

#define IR_CODE_STOP			0x0C
#define IR_CODE_UP				0x18
#define IR_CODE_SETUP			0x5E

#define IR_CODE_LEFT			0x08
#define IR_CODE_ENTER			0x1C
#define IR_CODE_RIGHT			0x5A

#define IR_CODE_NAV_DOWN		0x42
#define IR_CODE_DOWN			0x52
#define IR_CODE_NAV_UP			0x5A

#define IR_CODE_ANGLE			IR_INVALIDATE
#define IR_CODE_SLOW			IR_INVALIDATE
#define IR_CODE_ST 				IR_INVALIDATE
#define IR_CODE_ZOOM  			IR_INVALIDATE
#define IR_CODE_LOC 			IR_INVALIDATE
#define IR_CODE_SUB_T			IR_INVALIDATE
#define IR_CODE_PBC				IR_INVALIDATE
#define IR_CODE_OSD				IR_INVALIDATE
#define IR_CODE_AUDIO			IR_INVALIDATE
...
#define IR_CODE_M10				IR_INVALIDATE
#define IR_CODE_GOTO 			IR_INVALIDATE
