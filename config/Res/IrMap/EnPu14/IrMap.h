...
#define IR_CODE_ADD_VOL				0x1E

#define IR_CODE_RADIO				0x58
#define IR_CODE_NAV_UP				0x1B
...
#define IR_CODE_NAV_DOWN 			0x1A
#define IR_CODE_BAND				0x18

#define IR_CODE_POWER				0x5D
#define IR_CODE_PLAY				0x1D
#define IR_CODE_MODE				0x1C
