...
#define LI_R1					L2I(1,42)
#define LI_R2					L2I(2,42)
#define LI_R3					L2I(3,42)
/*-------------------------------------*/
//#define LI_MUTE				LI_NULL
#define LI_LOUD				   L2I(1,41)
/*-------------------------------------*/
#define LI_INT					L2I(2,48)
#define LI_RDM					L2I(3,48)
#define LI_RPT					L2I(1,48)
/*-------------------------------------*/
#define LI_FILE					LI_NULL
#define LI_FOLDER				LI_NULL
#define LI_MUSIC				 LI_NULL
#define LI_ALBUM				LI_NULL
#define LI_ARTIST				L2I(2,47)
#define LI_TITLE				L2I(1,25)
#define LI_ID3					LI_NULL

/*-------------------------------------*/
#define LI_PTY					L2I(3,31)
#define LI_EON					LI_NULL
#define LI_REG					LI_NULL
#define LI_TP					L2I(3,20)
#define LI_AF					L2I(3,10)
#define LI_TA					L2I(3,15)

/*-------------------------------------*/	
#define LI_EQ					L2I(2,46)
#define LI_POP					L2I(2,43)
//#define LI_FLAT				LI_NULL
#define LI_ROCK					L2I(1,43)
#define LI_CLASS				L2I(3,43)
//#define LI_JAZZ				LI_NULL
/*-------------------------------------*/
#define LI_VBAR_6				L2I(3,51)
#define LI_VBAR_5				L2I(1,50)
#define LI_VBAR_4				L2I(2,50)
#define LI_VBAR_3				L2I(3,50)
#define LI_VBAR_2				L2I(1,49)
#define LI_VBAR_1				L2I(2,49)
#define LI_VBAR_7				LI_NULL

#define LI_VBAR6_6				L2I(1,45)
#define LI_VBAR5_5				L2I(2,45)
#define LI_VBAR4_4				L2I(3,45)
#define LI_VBAR3_3				L2I(1,44)
#define LI_VBAR2_2				L2I(2,44)
#define LI_VBAR1_1				L2I(3,44)
#define LI_VBAR7_7				LI_NULL

/*-------------------------------------*/
#define LI_SUBWOOFER			LI_NULL
//#define LI_ESP45				LI_NULL
#define LI_BLUETOOTH			LI_NULL
#define LI_POWER				L2I(2,51)
#define LI_POWER2				L2I(3,46)
/*-------------------------------------*/
//#define LI_RADIO				LI_NULL
#define LI_TRACK				LI_NULL//L2I(3,26)
//#define LI_DISC					L2I(2,4)
...
#define LI_MP3					L2I(3,5)
#define LI_MP4					LI_NULL//L2I(3,47)
//define LI_MP5					LI_NULL
#define LI_WMA					L2I(1,46)
//#define LI_WAV					LI_NULL
//#define LI_ASF					LI_NULL
#define LI_CD					LI_NULL//L2I(1,51)
//#define LI_CDC					LI_NULL
#define LI_VCD					LI_NULL//L2I(3,49)
#define LI_DVD					LI_NULL//L2I(3,41)
//#define LI_JPG					LI_NULL
/*-------------------------------------*/
#define LI_LOC					L2I(2,52)
#define LI_STO					L2I(3,1) 
#define LI_MONO					L2I(1,52) 

/*-------------------------------------*/
#define LI_CLOCK				L2I(3,30)
#define LI_POINT				L2I(3,30)

//#define LI_POINT2				L2I(2,25)
