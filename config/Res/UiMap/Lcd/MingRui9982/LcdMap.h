...
#if !defined(_DISABLE_ICON_DISPLAY_)
#define LI_LOUD				    L2I(2,2)
#endif
/*-------------------------------------*/
...
#define LI_MP3					L2I(3,2)
#define LI_MP4					LI_NULL
#define LI_MP5					LI_NULL
#define LI_WMA					L2I(1,2)
//#define LI_WAV					LI_NULL
//#define LI_ASF					LI_NULL
#define LI_CD					L2I(2,15)
//#define LI_CDC					LI_NULL
#define LI_VCD					L2I(3,15)
#define LI_DVD					L2I(4,15)
