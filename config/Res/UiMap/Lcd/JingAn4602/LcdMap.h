...
/*-------------------------------------*/
#define LI_INT					L2I2(3,24)
#define LI_RDM					L2I2(1,24)
#define LI_RPT					L2I2(2,24)
/*-------------------------------------*/
...
/*-------------------------------------*/
#define LI_PTY					L2I2(1,4)
#define LI_AF					L2I2(3,4)
//#define LI_EON					LI_NULL
//#define LI_REG					LI_NULL
#define LI_TA					L2I2(2,4)
#define LI_TP					LI_NULL
/*-------------------------------------*/
#define LI_EQ					LI_NULL
#define LI_POP					L2I2(2,3)
#define LI_FLAT					LI_NULL
#define LI_ROCK					L2I2(4,3)
#define LI_CLASS				L2I2(3,3)
