...
#define LI_LOUD					LI_NULL//L2I2(2,23)
/*-------------------------------------*/
#define LI_INT					L2I2(2,22)
#define LI_RDM					L2I2(4,22)
#define LI_RPT					L2I2(3,22)
/*-------------------------------------*/
...
/*-------------------------------------*/
#define LI_EQ					L2I2(4,24)
#define LI_POP					L2I2(3,24)
#define LI_FLAT					LI_NULL
#define LI_ROCK					L2I2(1,24)
#define LI_CLASS				L2I2(2,24)
...
#define LI_USB					L2I2(1,2)
#define LI_SD					L2I2(2,2)
#define LI_MP3					LI_NULL//L2I2(3,23)//
//#define LI_WAV					LI_NULL
//#define LI_ASF					LI_NULL
#define LI_WMA					LI_NULL//L2I2(4,23)
...
#define LI_STO					L2I2(1,22) //
#define LI_LOC					LI_NULL
//#define LI_ST					LI_NULL
//#define LI_MONO				LI_NULL
#define LI_DASH					L2I2(3,2)

#define LI_CLOCK				L2I2(1,19)//
