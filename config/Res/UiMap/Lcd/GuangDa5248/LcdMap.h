...
#define LI_RPT					L2I2(1,32),L2I2(2,32)
#define LI_RDM					L2I2(3,32)
/*-------------------------------------*/
...
/*-------------------------------------*/
#define LI_CLOCK				L2I2(4,23),L2I2(3,23)
#define LI_POINT				L2I2(2,23)

//#define LI_T1					LI_NULL
//#define LI_CH					LI_NULL
/*-------------------------------------*/
//#define LI_ST					LI_NULL
#define LI_STO					L2I2(1,23) 
