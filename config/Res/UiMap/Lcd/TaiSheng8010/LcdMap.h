...
#define LI_R1					L2I2(1,28)//
#define LI_R2					L2I2(2,28)//
#define LI_R3					L2I2(3,28)//
//#define LI_R4					LI_NULL
/*-------------------------------------*/
//#define LI_TRACK				LI_NULL
//#define LI_DISC					LI_NULL
//#define LI_MUTE					LI_NULL
#define LI_LOUD					L2I2(1,30)
/*-------------------------------------*/
#define LI_INT					L2I2(1,29)
#define LI_RDM					L2I2(3,29)
#define LI_RPT					L2I2(2,29)
/*-------------------------------------*/
...
/*-------------------------------------*/
#define LI_PTY					L2I2(2,31)
#define LI_AF					L2I2(4,31)
#define LI_EON					LI_NULL
//#define LI_REG					LI_NULL
#define LI_TA					L2I2(3,31)
#define LI_TP					LI_NULL
/*-------------------------------------*/
#define LI_EQ					LI_NULL
#define LI_POP					LI_NULL
#define LI_FLAT					LI_NULL
#define LI_ROCK					L2I2(2,30)
#define LI_CLASS				L2I2(4,30)
#define LI_JAZZ					L2I2(3,30)
/*-------------------------------------*/
