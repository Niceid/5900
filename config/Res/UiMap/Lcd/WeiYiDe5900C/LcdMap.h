...
#define LI_AF					L2I2(1,11)
//#define LI_EON					LI_NULL
//#define LI_REG					LI_NULL
#define LI_TA					L2I2(2,11)
#define LI_TP					LI_NULL
/*-------------------------------------*/	
#define LI_EQ					L2I2(6,11)
#define LI_POP					L2I2(5,11)
//#define LI_FLAT					LI_NULL
#define LI_ROCK					L2I2(4,11)
#define LI_CLASS				L2I2(3,11)
