...
#define LI_R1					L2I2(4,30)
#define LI_R2					L2I2(3,30)
#define LI_R3					L2I2(2,30)
#define LI_R4					L2I2(1,30)
/*-------------------------------------*/
//#define LI_MUTE				LI_NULL
#define LI_LOUD				    L2I2(1,28)
/*-------------------------------------*/
#define LI_INT					L2I2(2,25)
#define LI_RDM					L2I2(2,29)
#define LI_RPT					L2I2(1,29)
/*-------------------------------------*/
...
/*-------------------------------------*/
#define LI_VBAR_1				L2I2(4,31)
#define LI_VBAR_2				L2I2(3,31)
#define LI_VBAR_3				L2I2(2,31)
...
#define LI_USB					L2I2(1,32)
#define LI_SD					L2I2(4,32)
...
/*-------------------------------------*/
#define LI_CLOCK				L2I2(3,29)
#define LI_POINT				L2I2(4,29)

//#define LI_T1					LI_NULL
//#define LI_CH					LI_NULL
/*-------------------------------------*/
#define LI_ST					L2I2(3,28) 
#define LI_STO					L2I2(2,28) 
