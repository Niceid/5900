...
#define LI_EON					LI_NULL//L2I(2,41)//
#define LI_REG					LI_NULL//L2I(3,52)//
#define LI_TA					L2I(3,15)//
#define LI_TP					L2I(3,20)//
/*-------------------------------------*/
#define LI_EQ					L2I(2,46)//
#define LI_POP					LI_NULL//L2I(2,43)//
#define LI_FLAT					LI_NULL
#define LI_ROCK					LI_NULL//L2I(1,43)//
#define LI_CLASS				LI_NULL//L2I(3,43)//
#define LI_JAZZ					LI_NULL
/*-------------------------------------*/
#define LI_VBAR_6				LI_NULL//L2I(3,44)//
#define LI_VBAR_5				L2I(2,44)//
#define LI_VBAR_4				L2I(1,44)//
#define LI_VBAR_3				L2I(3,45)//
#define LI_VBAR_2				L2I(2,45)//
#define LI_VBAR_1				L2I(1,45)//

#if defined(SUPPORT_ANTENNA_DISPLAY_)
#define LI_L21				    L2I(1,50)//
#define LI_L22				    L2I(2,50)//
#define LI_L23				    L2I(1,49)//
#define LI_L24				    L2I(2,49)//
#endif

/*-------------------------------------*/
#define LI_SUBWOOFER			LI_NULL//L2I(3,47)//
#define LI_BLUETOOTH			L2I(1,52)//	
#define LI_ESP45				LI_NULL
#define LI_SCDP					L2I(1,48)//
/*-------------------------------------*/
#define LI_RADIO				L2I(3,46)
...
/*-------------------------------------*/
#define LI_POWER				LI_NULL//L2I(3,46)//L1
