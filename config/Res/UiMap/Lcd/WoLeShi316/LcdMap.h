...
#define LI_LOUD				    L2I(1,1)
/*-------------------------------------*/
#define LI_INT					L2I(1,30)
#define LI_RDM					L2I(3,30)
#define LI_RPT					L2I(2,30)
/*-------------------------------------*/
...
/*-------------------------------------*/
#define LI_PTY					L2I(2,2)
#define LI_AF					L2I(1,2)
#define LI_EON					L2I(4,30)
//#define LI_REG					LI_NULL
#define LI_TA					L2I(3,2)
#define LI_TP					L2I(4,2)
/*-------------------------------------*/	
#define LI_EQ					LI_NULL
#define LI_POP					L2I(4,31)
//#define LI_FLAT					LI_NULL
#define LI_ROCK					L2I(2,1)
#define LI_CLASS				L2I(3,1)
//#define LI_JAZZ					LI_NULL
/*-------------------------------------*/
#define LI_VBAR_1				L2I(4,21)
#define LI_VBAR_2				L2I(1,21)
#define LI_VBAR_3				L2I(2,21)
#define LI_VBAR_4				L2I(3,21)
#define LI_VBAR_5				L2I(2,32)
#define LI_VBAR_6				L2I(3,32)
#define LI_VBAR_7				L2I(4,32)
/*-------------------------------------*/
//#define LI_SUBWOOFER			LI_NULL
//#define LI_ESP45				LI_NULL
#define LI_BLUETOOTH			L2I(1,31)
#define LI_POWER				L2I(1,32)
/*-------------------------------------*/
//#define LI_RADIO				LI_NULL
//#define LI_TRACK				LI_NULL
//#define LI_DISC					LI_NULL
#define LI_USB					L2I(3,31)
#define LI_SD					L2I(2,31)
...
/*-------------------------------------*/
#define LI_CLOCK				L2I(4,22)
#define LI_POINT				L2I(4,22)
