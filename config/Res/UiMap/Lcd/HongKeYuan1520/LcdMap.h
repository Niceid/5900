...
#define LI_R1					L2I2(3,31),L2I2(4,32)
#define LI_R2					L2I2(3,32),L2I2(2,32)
#define LI_R3					L2I2(1,31),L2I2(2,31)
//#define LI_R4					L2I2(1,32)

/*-------------------------------------*/
#define LI_MUTE					LI_NULL
#define LI_LOUD					L2I2(4,21)
/*-------------------------------------*/
#define LI_INT					L2I2(1,21)
#define LI_RDM					L2I2(3,21)
#define LI_RPT					L2I2(2,21)
/*-------------------------------------*/
...
/*-------------------------------------*/
#define LI_PTY					L2I2(4,1)
#define LI_AF					L2I2(3,1)
#define LI_EON					LI_NULL
//#define LI_REG				LI_NULL
#define LI_TA					L2I2(1,1)
#define LI_TP					L2I2(2,1)
/*-------------------------------------*/	
...
/*-------------------------------------*/
#define LI_VBAR_1				L2I2(1,30)
#define LI_VBAR_2				L2I2(2,30)
#define LI_VBAR_3				L2I2(3,30)
#define LI_VBAR_4				LI_NULL
/*-------------------------------------*/
//#define LI_SUBWOOFER			LI_NULL
#define LI_POWER				L2I2(1,29)
#define LI_BLUETOOTH			L2I2(4,20)
/*-------------------------------------*/
#define LI_RADIO				L2I2(4,30)
//#define LI_TRACK				LI_NULL
//#define LI_DISC					LI_NULL
#define LI_USB					L2I2(1,20)
#define LI_SD					L2I2(4,31)
//#define LI_AUX					LI_NULL
//#define LI_FLASH				LI_NULL
#define LI_PLAYER				L2I2(1,32)
...
/*-------------------------------------*/
#define LI_CLOCK				L2I2(3,20)
#define LI_POINT				L2I2(2,20)
