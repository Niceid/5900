...
#define L1I_SEG(SEG)			((36 - SEG) * _END_COM_)
...
/*-------------------------------------*/
#define LI_VBAR_1				L2I(1,6)
#define LI_VBAR_2				L2I(2,6)
#define LI_VBAR_3				L2I(3,6)
#define LI_VBAR_4				L2I(4,6)
/*-------------------------------------*/
...
#define LI_USB					L2I(2,5)
#define LI_SD					L2I(1,5)
//#define LI_AUX					LI_NULL
//#define LI_FLASH				LI_NULL

#define LI_MP3					L2I(4,5)
...
/*-------------------------------------*/
#define LI_CLOCK				L2I(1,26)
#define LI_POINT				L2I(1,26)

//#define LI_T1					LI_NULL
//#define LI_CH					LI_NULL
/*-------------------------------------*/
//#define LI_ST					LI_NULL
#define LI_STO					L2I(1,28) 
