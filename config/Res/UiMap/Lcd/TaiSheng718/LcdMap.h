...
#define LI_LOUD				    L2I2(4,30)
/*-------------------------------------*/
#define LI_INT					L2I2(2,28)
#define LI_RDM					L2I2(1,32)
#define LI_RPT					L2I2(2,32)
/*-------------------------------------*/
...
/*-------------------------------------*/
#define LI_PTY					L2I2(2,29)
#define LI_AF					L2I2(3,28)
#define LI_EON					L2I2(3,30)
//#define LI_REG					LI_NULL
#define LI_TA					L2I2(4,28)
#define LI_TP					L2I2(1,29)
/*-------------------------------------*/	
#define LI_EQ					LI_NULL
#define LI_POP					L2I2(2,31)
#define LI_FLAT					L2I2(3,32)
#define LI_ROCK					L2I2(3,31)
#define LI_CLASS				L2I2(4,31)
#define LI_JAZZ					L2I2(4,32)
/*-------------------------------------*/
#define LI_VBAR_1				L2I2(2,27)
#define LI_VBAR_2				L2I2(3,27)
#define LI_VBAR_3				L2I2(4,27)
#define LI_VBAR_4				LI_NULL
#define LI_VBAR_5				L2I2(1,28)
/*-------------------------------------*/
//#define LI_SUBWOOFER			LI_NULL
//#define LI_ESP45				LI_NULL
#define LI_BLUETOOTH			L2I2(2,30)
#define LI_POWER				LI_NULL
/*-------------------------------------*/
//#define LI_RADIO				LI_NULL
//#define LI_TRACK				LI_NULL
//#define LI_DISC					LI_NULL
#define LI_USB					L2I2(1,31)
#define LI_SD					L2I2(1,30)
//#define LI_AUX					LI_NULL
//#define LI_FLASH				LI_NULL

#define LI_MP3					L2I2(3,29)
//#define LI_MP4					LI_NULL
//#define LI_MP5					LI_NULL
#define LI_WMA					L2I2(4,29)
