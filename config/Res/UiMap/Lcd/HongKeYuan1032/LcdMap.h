...
/*-------------------------------------*/
#define LI_INT					L2I2(4,11)
#define LI_RDM					LI_NULL
#define LI_RPT					L2I2(3,11)
/*-------------------------------------*/
...
#define LI_USB					L2I2(3,7)
#define LI_SD					L2I2(2,7)
...
/*-------------------------------------*/
#define LI_CLOCK				L2I2(1,7)
#define LI_POINT				L2I2(2,11)
...
#define LI_TEMP					L2I2(3,25)//L2I2(3,27)
#define LI_WARM					L2I2(2,25)//L2I2(2,27)
#define LI_SET					L2I2(1,25)//L2I2(1,27)
