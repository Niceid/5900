...
#define SF3						LI_I
#define SF4						LI_M
#define SF5						(LI_G|LI_H)
#define SF6						LI_K
#define SF7						(LI_G|LI_H)
#define SF8						LI_L
#define SF9						LI_J
#define SFA						LI_E
#define SFB						LI_C
...
#define LI_LOUD				    L2I2(1,1)
/*-------------------------------------*/
#define LI_INT					L2I2(1,30)
#if defined(_CHANGE_PLAY_ICON_)
#define LI_RDM					L2I2(3,30)
#define LI_RPT					L2I2(2,30)
#else
#define LI_RDM					L2I2(2,30)
#define LI_RPT					L2I2(3,30)
#endif
/*-------------------------------------*/
...
/*-------------------------------------*/
#define LI_PTY					L2I2(2,2)
#define LI_AF					L2I2(1,2)
#define LI_EON					L2I2(4,30)
//#define LI_REG					LI_NULL
#define LI_TA					L2I2(3,2)
#define LI_TP					L2I2(4,2)
/*-------------------------------------*/
#if defined(_DISABLE_EQ_POWER_DISPLAY_)
#define LI_EQ				L2I2(1,32)
#else
#define LI_EQ					LI_NULL 
#endif
#define LI_POP					L2I2(4,31)
//#define LI_FLAT					LI_NULL
#define LI_ROCK					L2I2(2,1)
#define LI_CLASS				L2I2(3,1)
//#define LI_JAZZ					LI_NULL
/*-------------------------------------*/
#define LI_VBAR_1				L2I2(4,21)
#define LI_VBAR_2				L2I2(1,21)
#define LI_VBAR_3				L2I2(2,21)
#define LI_VBAR_4				L2I2(3,21)
#define LI_VBAR_5				L2I2(2,32)
#define LI_VBAR_6				L2I2(3,32)
#define LI_VBAR_7				L2I2(4,32)
#define LI_VBAR_8				L2I2(4,1)

/*-------------------------------------*/
//#define LI_SUBWOOFER			LI_NULL
//#define LI_ESP45				LI_NULL
#define LI_BLUETOOTH			L2I2(1,31)
#if defined(_DISABLE_EQ_POWER_DISPLAY_)
#define LI_POWER				LI_NULL
#else
#define LI_POWER				L2I2(1,32)
#endif
/*-------------------------------------*/
#define LI_RADIO				LI_NULL
//#define LI_TRACK				LI_NULL
//#define LI_DISC					LI_NULL
#define LI_USB					L2I2(3,31)
#define LI_SD					L2I2(2,31)
...
/*-------------------------------------*/
#define LI_CLOCK				L2I2(4,22)
#define LI_POINT				L2I2(4,22)
