...
/*-------------------------------------*/
#define LI_MUTE					L2I(3,11)
#define LI_LOUD				    L2I(3,41)
/*-------------------------------------*/
#define LI_INT					L2I(2,11)
#define LI_RDM					L2I(2,21)
#define LI_RPT					L2I(3,26)
/*-------------------------------------*/
#define LI_FILE					L2I(3,36)
#define LI_FOLDER				L2I(3,31)
#define LI_MUSIC				L2I(2,31)
#define LI_ALBUM				L2I(2,36)
#define LI_ARTIST				L2I(2,41)
#define LI_TITLE				LI_NULL
#define LI_ID3					LI_NULL

/*-------------------------------------*/
#define LI_PTY					L2I(3,42)
#define LI_EON					L2I(3,43)
#define LI_REG					LI_NULL
#define LI_TP					L2I(1,43)
#define LI_AF					L2I(2,42)
#define LI_TA					L2I(2,43)

/*-------------------------------------*/	
#define LI_EQ					L2I(3,44)
#define LI_POP					L2I(2,44)
#define LI_FLAT					L2I(3,45)
#define LI_ROCK					L2I(1,45)
#define LI_CLASS				L2I(3,46)
#define LI_JAZZ					LI_NULL
/*-------------------------------------*/
#define LI_VBAR_7				L2I(1,48)
#define LI_VBAR_6				L2I(3,49)
#define LI_VBAR_5				L2I(2,49)
#define LI_VBAR_4				L2I(1,49)
#define LI_VBAR_3				L2I(3,50)
#define LI_VBAR_2				L2I(2,50)
#define LI_VBAR_1				L2I(1,50)

#define LI_VBAR4_4				L2I(2,6)
#define LI_VBAR3_3				L2I(3,6)
#define LI_VBAR2_2				L2I(2,1)
#define LI_VBAR1_1				L2I(3,1)

/*-------------------------------------*/
#define LI_SUBWOOFER			L2I(2,51)
//#define LI_ESP45				LI_NULL
#define LI_BLUETOOTH			LI_NULL
#define LI_POWER				L2I(3,51)
#define LI_POWER2				LI_NULL
/*-------------------------------------*/
//#define LI_RADIO				LI_NULL
#define LI_TRACK				L2I(2,16)
#define LI_DISC					L2I(3,21)
...
#define LI_STO					L2I(1,41) 
#define LI_MONO					LI_NULL
/*-------------------------------------*/
#define LI_CLOCK				L2I(1,42)
#define LI_POINT				L2I(1,42)
