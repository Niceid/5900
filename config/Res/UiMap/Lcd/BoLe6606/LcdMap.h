...
#define LI_LOUD					L2I2(4,10)
/*-------------------------------------*/
#define LI_INT					L2I2(4,12)
#define LI_RDM					L2I2(4,13)
#define LI_RPT					L2I2(4,11)
/*-------------------------------------*/
...
/*-------------------------------------*/
#define LI_PTY					L2I2(4,8)
#define LI_AF					L2I2(4,7)
#define LI_EON					LI_NULL
//#define LI_REG					LI_NULL
#define LI_TA					L2I2(4,3)
#define LI_TP					L2I2(4,6)
/*-------------------------------------*/
#define LI_EQ					L2I2(4,16)
#define LI_POP					L2I2(4,30)
#define LI_FLAT					L2I2(4,18)
#define LI_ROCK					L2I2(4,22)
#define LI_CLASS				L2I2(4,26)
#define LI_JAZZ					LI_NULL
/*-------------------------------------*/
#define LI_VBAR_1				L2I2(4,17)//
#define LI_VBAR_2				L2I2(4,19)//
#define LI_VBAR_3				L2I2(4,20)//
#define LI_VBAR_4				L2I2(4,21)//
/*-------------------------------------*/
...
#define LI_USB					L2I2(4,15)
#define LI_SD					L2I2(4,14)
#define LI_MP3					LI_NULL//
//#define LI_WAV					LI_NULL
//#define LI_ASF					LI_NULL
#define LI_WMA					L2I2(4,2)
