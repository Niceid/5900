...
/*-------------------------------------*/
#define LI_PTY					L2I2(3,29)//
#define LI_AF					L2I2(3,7)//
#define LI_EON					LI_NULL
#define LI_REG					LI_NULL
#define LI_TA					L2I2(2,7)//
#define LI_TP					L2I2(1,20)//
/*-------------------------------------*/
#define LI_EQ					L2I2(1,31)//
...
#define LI_VBAR_4				L2I2(3,31)//
#define LI_VBAR_3				L2I2(3,32)//
#define LI_VBAR_2				L2I2(2,32)//
#define LI_VBAR_1				L2I2(1,32)//	

/*-------------------------------------*/
#define LI_SUBWOOFER			LI_NULL
#define LI_BLUETOOTH			L2I2(2,20)//		
#define LI_ESP45				LI_NULL
/*-------------------------------------*/
#define LI_TRACK				LI_NULL
#define LI_RADIO				L2I2(1,7)//
#define LI_AUX					LI_NULL
#define LI_FLASH				LI_NULL
#define LI_USB					LI_NULL//L2I2(1,30)//
#define LI_SD					LI_NULL//L2I2(2,30)//
