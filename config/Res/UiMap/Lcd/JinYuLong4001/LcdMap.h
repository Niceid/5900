...
#define LI_R1					L2I2(4,2)
#define LI_R2					L2I2(4,1)
#define LI_R3					L2I2(1,1)
/*-------------------------------------*/
//#define LI_MUTE				LI_NULL
#define LI_LOUD				    L2I2(3,6)
/*-------------------------------------*/
#define LI_INT					L2I2(2,32)
#define LI_RDM					L2I2(1,20)
#define LI_RPT					L2I2(3,13)
/*-------------------------------------*/
...
/*-------------------------------------*/
#define LI_PTY					L2I2(2,13)
#define LI_AF					L2I2(1,13)
...
#define LI_VBAR_3				L2I2(3,2)
#define LI_VBAR_4				L2I2(2,2)
#define LI_VBAR_5				L2I2(1,2)

/*-------------------------------------*/
//#define LI_SUBWOOFER			LI_NULL
//#define LI_ESP45				LI_NULL
#define LI_BLUETOOTH			L2I2(3,32)
#define LI_POWER				LI_NULL
/*-------------------------------------*/
//#define LI_RADIO				LI_NULL
//#define LI_TRACK				LI_NULL
//#define LI_DISC					LI_NULL
#define LI_USB					L2I2(2,20)
#define LI_SD					L2I2(2,1)
...
#define LI_CH					L2I2(1,31)
/*-------------------------------------*/
//#define LI_ST					LI_NULL
#define LI_STO					L2I2(1,29)
