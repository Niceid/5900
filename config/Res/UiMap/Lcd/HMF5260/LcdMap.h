...
/*-------------------------------------*/	
#define LI_EQ					L2I2(6,1)

#define LI_POP					L2I2(5,1)
//#define LI_FLAT					LI_NULL
#define LI_ROCK					L2I2(4,1)
#define LI_CLASS				L2I2(3,1)
//#define LI_JAZZ					LI_NULL
/*-------------------------------------*/
#define LI_VBAR_1				L2I2(1,11)
#define LI_VBAR_2				L2I2(2,11)
...
#define LI_SD					L2I2(4,11)
//#define LI_AUX					LI_NULL
//#define LI_FLASH				LI_NULL

#define LI_MP3					L2I2(6,11)
