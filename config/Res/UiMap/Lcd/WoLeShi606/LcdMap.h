...
#define LI_TP					L2I2(4,23)
/*-------------------------------------*/	
#define LI_EQ					L2I2(1,15)
#define LI_POP					L2I2(3,16)
#define LI_FLAT					L2I2(1,32)
...
#define LI_VBAR_4				L2I2(4,2)
/*-------------------------------------*/
//#define LI_SUBWOOFER			LI_NULL
#define LI_POWER				LI_NULL//L2I2(4,1)
#define LI_BLUETOOTH			L2I2(3,23)
/*-------------------------------------*/
...
#define LI_MP3					L2I2(3,2)
//#define LI_MP4					LI_NULL
//#define LI_MP5					LI_NULL
#define LI_WMA					L2I2(1,2)
//#define LI_WAV					LI_NULL
//#define LI_ASF					LI_NULL
#define LI_CD					L2I2(2,15)
#define LI_VCD					L2I2(3,15)
#define LI_DVD					L2I2(4,15)
//#define LI_JPG					LI_NULL
/*-------------------------------------*/
#define LI_CLOCK				L2I2(1,23)
...
#define LI_R1					L2I2(3,1)
#define LI_R2					L2I2(2,1)
#define LI_R3					L2I2(1,1)
/*-------------------------------------*/
#define LI_MUTE					LI_NULL
#define LI_LOUD					L2I2(4,2)
/*-------------------------------------*/
#define LI_INT					L2I2(3,17)
#define LI_RDM					L2I2(2,17)
#define LI_RPT					L2I2(1,17)
/*-------------------------------------*/
//#define LI_FILE					LI_NULL
//#define LI_FOLDER				LI_NULL
//#define LI_MUSIC				LI_NULL
...
//#define LI_ARTIST				LI_NULL
/*-------------------------------------*/
#define LI_PTY					L2I2(3,16)
#define LI_AF					L2I2(2,16)
#define LI_EON					L2I2(1,16)
//#define LI_REG					LI_NULL
#define LI_TA					L2I2(4,16)
#define LI_TP					L2I2(4,17)
/*-------------------------------------*/	
#define LI_EQ					L2I2(4,1)
...
//#define LI_JAZZ					LI_NULL
/*-------------------------------------*/
#define LI_VBAR_1				L2I2(1,32)
#define LI_VBAR_2				L2I2(4,32)
#define LI_VBAR_3				L2I2(4,3)
#define LI_VBAR_4				L2I2(3,3)
#define LI_VBAR_5				L2I2(2,3)
#define LI_VBAR_6				L2I2(1,3)
...
//#define LI_RADIO				LI_NULL
//#define LI_TRACK				LI_NULL
#define LI_DISC					L2I2(3,2)
#define LI_USB					L2I2(2,2)
#define LI_SD					L2I2(1,2)
//#define LI_AUX					LI_NULL
//#define LI_FLASH				LI_NULL
...
//#define LI_JPG					LI_NULL
/*-------------------------------------*/
#define LI_CLOCK				L2I2(4,31)
#define LI_POINT				L2I2(4,31)

//#define LI_T1					LI_NULL
//#define LI_CH					LI_NULL
/*-------------------------------------*/
//#define LI_ST					LI_NULL
#define LI_STO					L2I2(3,32) 
//#define LI_LOC					LI_NULL
#endif
