...
#define LI_R1					L2I(3,31)
#define LI_R2					L2I(2,31)
#define LI_R3					L2I(1,31)
/*-------------------------------------*/
//#define LI_MUTE				LI_NULL
#define LI_LOUD				    L2I(3,10)
/*-------------------------------------*/
#define LI_INT					L2I(4,18)
#define LI_RDM					L2I(3,18)
#define LI_RPT					L2I(2,18)
/*-------------------------------------*/
...
/*-------------------------------------*/
#define LI_PTY					L2I(4,8)
#define LI_AF					L2I(2,8)
#define LI_EON					L2I(1,8)
#define LI_REG					LI_NULL
#define LI_TA					L2I(3,8)
#define LI_TP					L2I(4,10)

/*-------------------------------------*/	
#define LI_EQ					L2I(1,18)
#define LI_POP					L2I(3,17)
//#define LI_FLAT					LI_NULL
#define LI_ROCK					L2I(2,17)
#define LI_CLASS				L2I(4,17)
//#define LI_JAZZ					LI_NULL
/*-------------------------------------*/
#define LI_VBAR_1				L2I(3,32)
#define LI_VBAR_2				L2I(2,32)
#define LI_VBAR_3				L2I(1,32)
#define LI_VBAR_4				L2I(4,31)
/*-------------------------------------*/
//#define LI_SUBWOOFER			LI_NULL
//#define LI_ESP45				LI_NULL
#define LI_BLUETOOTH			LI_NULL
#if defined(_DISABLE_L1_DISPLAY_)
#define LI_POWER				LI_NULL
#else
#define LI_POWER				L2I(4,32)
#endif
/*-------------------------------------*/
//#define LI_RADIO				LI_NULL
//#define LI_TRACK				LI_NULL
//#define LI_DISC					LI_NULL
#define LI_USB					L2I(2,10)
...
/*-------------------------------------*/
#define LI_CLOCK				L2I(1,10)
#define LI_POINT				L2I(1,10)

//#define LI_T1					LI_NULL
//#define LI_CH					LI_NULL
/*-------------------------------------*/
//#define LI_ST					LI_NULL
#define LI_STO					L2I(1,17) 
