...
#define LI_STO					L2I(COM_2,SEG_32)
//#define LI_LOC					LI_NULL
#define LI_PTY					LI_NULL
#define LI_AF					L2I(COM_3,SEG_32)
#define LI_EON					LI_NULL
//#define LI_REG					LI_NULL
#define LI_TA					L2I(COM_4,SEG_32)
...
//Common
#define LI_CLOCK				L2I(COM_1,SEG_32)
