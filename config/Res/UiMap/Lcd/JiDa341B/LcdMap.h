...
#define LI_LOUD				    L2I(1,2)
/*-------------------------------------*/
#define LI_INT					L2I(4,24)
#define LI_RDM					L2I(2,24)
#define LI_RPT					L2I(3,24)
/*-------------------------------------*/
...
/*-------------------------------------*/	
#define LI_EQ					L2I(1,24)
#define LI_POP					L2I(4,23)
//#define LI_FLAT					LI_NULL
#define LI_ROCK					L2I(2,23)
#define LI_CLASS				L2I(3,23)
//#define LI_JAZZ					LI_NULL
/*-------------------------------------*/
#define LI_VBAR_1				L2I(1,1)
#define LI_VBAR_2				L2I(2,1)
#define LI_VBAR_3				L2I(3,1)
#define LI_VBAR_4				L2I(4,1)
/*-------------------------------------*/
...
/*-------------------------------------*/
#define LI_CLOCK				L2I(4,2)
#define LI_POINT				L2I(1,7)
#define LI_DASH					L2I(1,23)
