...
/*-------------------------------------*/
#define LI_MUTE				    L2I2(5,8)
#define LI_LOUD					LI_NULL
/*-------------------------------------*/
#define LI_INT					L2I2(5,5)
#define LI_RDM					L2I2(5,2)
#define LI_RPT					L2I2(5,4)
/*-------------------------------------*/
...
/*-------------------------------------*/
#if defined(_ENABLE_L1_POWER_)
#define LI_VBAR_1				L2I2(5,6)
#define LI_VBAR_2				L2I2(5,3)
#define LI_VBAR_3				L2I2(5,1)
#define LI_VBAR_4				LI_NULL
#define LI_VBAR_5				LI_NULL
#else
#define LI_VBAR_1				L2I2(5,7)
#define LI_VBAR_2				L2I2(5,6)
#define LI_VBAR_3				L2I2(5,3)
#define LI_VBAR_4				L2I2(5,1)
#define LI_VBAR_5				LI_NULL
#endif
/*-------------------------------------*/
...
#define LI_USB					L2I2(3,8)
#define LI_SD					L2I2(2,8)
