...
#define LI_AF					L2I2(3,11)
#define LI_EON					L2I2(3,18)
//#define LI_REG					LI_NULL
#define LI_TA					L2I2(4,4)
#define LI_TP					L2I2(4,11)
/*-------------------------------------*/	
...
/*-------------------------------------*/
#define LI_CLOCK				L2I2(4,18)
#define LI_POINT				L2I2(3,25)

//#define LI_T1					LI_NULL
//#define LI_CH					LI_NULL
/*-------------------------------------*/
//#define LI_ST					LI_NULL
#define LI_STO					L2I2(2,32) 
