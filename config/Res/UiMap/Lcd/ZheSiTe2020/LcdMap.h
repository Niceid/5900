...
#define LI_RDM					L2I2(4,26)
#define LI_RPT					L2I2(4,23)
/*-------------------------------------*/
...
#define LI_AF					L2I2(4,27)
//#define LI_EON					LI_NULL
//#define LI_REG					LI_NULL
#define LI_TA					L2I2(4,31)
...
/*-------------------------------------*/
#define LI_CLOCK				L2I2(4,25)
#define LI_POINT				L2I2(4,25)
...
#define LI_MHZ					L2I2(4,13)
#define LI_KHZ					L2I2(4,9)
