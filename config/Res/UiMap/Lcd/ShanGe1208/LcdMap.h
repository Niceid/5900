...
/*-------------------------------------*/
#define LI_INT					L2I2(5,12)
#define LI_RDM					L2I2(3,12)
#define LI_RPT					L2I2(4,12)
/*-------------------------------------*/
...
/*-------------------------------------*/
#define LI_PTY					L2I2(6,12)
#define LI_AF					L2I2(1,1)
//#define LI_EON					LI_NULL
//#define LI_REG					LI_NULL
#define LI_TA					L2I2(2,1)
#define LI_TP					LI_NULL
/*-------------------------------------*/	
#define LI_EQ					LI_NULL

#define LI_POP					L2I2(6,1)
#define LI_FLAT					L2I2(3,1)
#define LI_ROCK					L2I2(4,1)
#define LI_CLASS				L2I2(5,1)
//#define LI_JAZZ					LI_NULL
/*-------------------------------------*/
#define LI_VBAR_1				L2I2(5,14)
#define LI_VBAR_2				L2I2(4,14)
#define LI_VBAR_3				L2I2(3,14)
#define LI_VBAR_4				L2I2(2,14)
...
/*-------------------------------------*/
#define LI_CLOCK				L2I2(2,12)
#define LI_POINT				L2I2(1,12)
