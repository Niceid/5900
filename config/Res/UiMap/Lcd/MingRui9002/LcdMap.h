...
#if defined(_DISABLE_DISP_FUNC_)
#define LI_LOUD				    LI_NULL
#else
#define LI_LOUD				    L2I2(2,2)
#endif
/*-------------------------------------*/
#if defined(_DISABLE_ICON_DISP_)
...
//显示LCD配制
#if defined(_ENABLE_POWER_ON_BRVE_)||defined(_CHANGE_BRVE_DISP_)
