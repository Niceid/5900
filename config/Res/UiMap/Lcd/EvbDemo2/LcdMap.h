...
/*-------------------------------------*/
#define LI_INT					L2I2(1,1)
#define LI_RDM					L2I2(1,2)
#define LI_RPT					L2I2(1,3)
/*-------------------------------------*/
...
#define LI_BLUETOOTH			L2I2(1,9)
#define LI_POWER				L2I2(1,7)//EQ
...
/*-------------------------------------*/
#define LI_CLOCK				L2I2(2,1)
#define LI_POINT				L2I2(2,2)
