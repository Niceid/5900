...
#define LI_R1					L2I(1,3)
#define LI_R2					L2I(3,3)
#define LI_R3					L2I(2,3)
#define LI_R4					LI_NULL
/*-------------------------------------*/
#define LI_MUTE					L2I(1,13)
#define LI_LOUD				    LI_NULL
/*-------------------------------------*/
#define LI_INT					L2I(2,20)
#define LI_RDM					L2I(3,24)
#define LI_RPT					L2I(3,20)
/*-------------------------------------*/
...
/*-------------------------------------*/
#define LI_PTY					L2I(2,46)
#define LI_AF					L2I(3,35)
#define LI_EON					LI_NULL
#define LI_REG					LI_NULL
#define LI_TA					L2I(2,35)
#define LI_TP					LI_NULL
/*-------------------------------------*/	
#define LI_EQ					L2I(1,31)
#define LI_POP					L2I(1,35)
#define LI_FLAT					LI_NULL
#define LI_ROCK					L2I(1,42)
#define LI_CLASS				L2I(1,46)
#define LI_JAZZ					LI_NULL
/*-------------------------------------*/
#define LI_VBAR_1				L2I(1,2)
#define LI_VBAR_2				L2I(2,2)
#define LI_VBAR_3				L2I(3,2)
#define LI_VBAR_4				L2I(4,2)

/*-------------------------------------*/
#define LI_SUBWOOFER			LI_NULL
//#define LI_ESP45				LI_NULL
#define LI_BLUETOOTH			L2I(3,46)
#define LI_POWER				LI_NULL
/*-------------------------------------*/
#define LI_RADIO				LI_NULL
#define LI_TRACK				LI_NULL
#define LI_DISC					LI_NULL
#define LI_USB					L2I(3,13)
#define LI_SD					L2I(2,13)
#define LI_AUX					LI_NULL
#define LI_FLASH				LI_NULL

#define LI_MP3					L2I(2,24)
