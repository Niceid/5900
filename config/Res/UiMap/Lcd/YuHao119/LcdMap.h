...
/*-------------------------------------*/
#define LI_INT					L2I(4,16)
#define LI_RDM					L2I(6,16)
#define LI_RPT					L2I(5,16)
...
/*-------------------------------------*/
#define LI_PTY					L2I(1,9)
#define LI_AF					L2I(2,8)
//#define LI_EON					LI_NULL
//#define LI_REG					LI_NULL
#define LI_TA					L2I(2,9)
#define LI_TP					LI_NULL

/*-------------------------------------*/
#define LI_EQ					L2I(1,10)
#define LI_POP					L2I(1,6)
#define LI_FLAT					LI_NULL
#define LI_ROCK					L2I(2,6)
#define LI_CLASS				L2I(1,11)
#define LI_JAZZ					LI_NULL

/*-------------------------------------*/
#define LI_VBAR_1				L2I(2,5)//
#define LI_VBAR_2				L2I(1,5)//
#define LI_VBAR_3				L2I(1,4)//
#define LI_VBAR_4				L2I(2,4)//
...
#define LI_USB					L2I(2,7)
#define LI_SD					L2I(1,8)
