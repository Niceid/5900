...
#define L1I_SEG(SEG)			(((SEG<29)?(36-SEG):(SEG-29))* _END_COM_)

#define L1I(COM,SEG)			(L1I_SEG(SEG) + L1I_COM(COM))
#define L2I2(COM,SEG)			((uint16)(((L1I(COM,SEG)/8)<<8)|(L1I(COM,SEG)%8)))
...
/*-------------------------------------*/
#define LI_PTY					L2I2(4,36)
#define LI_AF					L2I2(2,36)
#define LI_EON					LI_NULL
//#define LI_REG					LI_NULL
#define LI_TA					L2I2(3,36)
#define LI_TP					L2I2(4,27)
/*-------------------------------------*/	
#define LI_EQ					L2I2(1,19)
#define LI_POP					L2I2(3,20)
#define LI_FLAT					L2I2(1,36)
#define LI_ROCK					L2I2(2,20)
#define LI_CLASS				L2I2(4,20)
#define LI_JAZZ					LI_NULL
/*-------------------------------------*/
#define LI_VBAR_1				L2I2(4,5)
#define LI_VBAR_2				L2I2(3,5)
#define LI_VBAR_3				L2I2(2,5)
#define LI_VBAR_4				L2I2(1,5)
#define LI_VBAR_5				L2I2(4,6)
/*-------------------------------------*/
//#define LI_SUBWOOFER			LI_NULL
//#define LI_ESP45				LI_NULL
#define LI_BLUETOOTH			L2I2(3,27)
#define LI_POWER				LI_NULL
/*-------------------------------------*/
//#define LI_RADIO				LI_NULL
//#define LI_TRACK				LI_NULL
//#define LI_DISC					LI_NULL
#define LI_USB					L2I2(2,27)
#define LI_SD					L2I2(4,35)
//#define LI_AUX					LI_NULL
//#define LI_FLASH				LI_NULL

#define LI_MP3					L2I2(3,6)
//#define LI_MP4					LI_NULL
//#define LI_MP5					LI_NULL
#define LI_WMA					L2I2(1,6)
//#define LI_WAV					LI_NULL
//#define LI_ASF					LI_NULL
#define LI_CD					L2I2(2,19)
//#define LI_CDC					LI_NULL
#define LI_VCD					L2I2(3,19)
#define LI_DVD					L2I2(4,19)
//#define LI_JPG					LI_NULL
/*-------------------------------------*/
#define LI_CLOCK				L2I2(1,27)
#define LI_POINT				L2I2(1,27)

//#define LI_T1					LI_NULL
//#define LI_CH					LI_NULL
/*-------------------------------------*/
//#define LI_ST					LI_NULL
#define LI_STO					L2I2(1,20)
