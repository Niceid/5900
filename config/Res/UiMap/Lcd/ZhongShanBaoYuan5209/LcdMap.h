...
/*-------------------------------------*/
#define LI_INT					L2I2(4,17)
#define LI_RDM					L2I2(3,17)
#define LI_RPT					L2I2(2,18)//RPT ONE

#define LI_RPT_ALL				L2I2(1,14)//RPT ONE
#define LI_RPT1					L2I2(1,18)//RPT
/*-------------------------------------*/
...
#define LI_FM					L2I2(1,1)
#define LI_MHZ					L2I2(1,16)
#define LI_PLAY					L2I2(3,2)
#define LI_PAUSE				L2I2(4,2)
