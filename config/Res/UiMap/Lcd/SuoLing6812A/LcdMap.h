...
/*-------------------------------------*/
#define LI_MUTE					L2I(4,16)
#define LI_LOUD				    LI_NULL
/*-------------------------------------*/
#define LI_INT					L2I(4,17)
#define LI_RDM					L2I(4,24)
#define LI_RPT					L2I(4,20)
/*-------------------------------------*/
...
#define LI_AF					L2I(4,25)
#define LI_EON					LI_NULL
#define LI_REG					LI_NULL
#define LI_TA					L2I(4,21)
...
#define LI_BLUETOOTH			L2I(4,5)
#define LI_POWER				LI_NULL
/*-------------------------------------*/
#define LI_RADIO				L2I(4,9)
#define LI_TRACK				L2I(4,13)//
#define LI_DISC					L2I(4,12)//
#define LI_USB					L2I(4,8)
#define LI_SD					L2I(4,4)
#define LI_AUX					L2I(4,1)
#define LI_FLASH				LI_NULL

#define LI_MP3					L2I(4,37)
//#define LI_MP4					LI_NULL
//#define LI_MP5					LI_NULL
#define LI_WMA					L2I(4,29)
...
#define LI_MHZ					L2I(4,40)
#define LI_KHZ					L2I(4,41)

#if defined(_SL6812_TEST_LCD_)
#define LI_LCD					L2I(4,28)//无用点
#endif

/*-------------------------------------*/
#define LI_CLOCK				L2I(4,33)
#define LI_POINT				L2I(4,32)

#define LI_T1					LI_NULL
#define LI_CH					L2I(3,41)
/*-------------------------------------*/
#define LI_ST					LI_NULL
#define LI_STO					L2I(4,36)
