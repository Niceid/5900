...
#if defined(_BL_CHANGE_PANEL_LIGHT_)
/*-----------PIN25(A11)-RED----------------------------------------------------------------------------------------------------*/
...
/*-----------PIN18(C2)-----------------------------------------------------------------------------------------------------*/
#define ILL_LIGHT_GPIO							_B2_

#define ILL_LIGHT_INIT()						do{JL_PORTC->PU |= ILL_LIGHT_GPIO; \
                                                   JL_PORTC->PD &= ~ILL_LIGHT_GPIO; \
                                                   JL_PORTC->HD |= ILL_LIGHT_GPIO;}while(0)
#define ILL_LIGHT_HIGH()						(JL_PORTC->OUT |= ILL_LIGHT_GPIO)
#define ILL_LIGHT_LOW()							(JL_PORTC->OUT &= ~ILL_LIGHT_GPIO)
#define ILL_LIGHT_OUT()							(JL_PORTC->DIR &= ~ILL_LIGHT_GPIO)
#define ILL_LIGHT_IN()							(JL_PORTC->DIR |= ILL_LIGHT_GPIO)
