...
//	KEY3--------GPIO PR1(PIN5)
#define ADC_KEY3_PIN						AD_KEY_PB9
...
#define IR_INIT_PIN							do{JL_PORTB->DIR |= _B30_; JL_PORTB->DIE |= _B30_;}while(0)
...
#if defined(_ENABLE_AMP_LIGHT_)//PIN42
#define AMP_CONTROL_GPIO						_B11_
...
//	SUB PIN(42)--------GPIO B11
/*----------------------------------------------------------------------------------------------------------------*/
#define SYS_SUB2_GPIO							_B30_    //ÎÞÓÃ
