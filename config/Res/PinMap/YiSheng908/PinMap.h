...
#define AUDIO_MUTE_HIGH()						(PORTR_OUT(AUDIO_MUTE_GPIO, 0))
#define AUDIO_MUTE_LOW()						(PORTR_OUT(AUDIO_MUTE_GPIO, 1))
#define AUDIO_MUTE_ON()							{AUDIO_MUTE_OUT();AUDIO_MUTE_LOW();}
#define AUDIO_MUTE_OFF()						{AUDIO_MUTE_OUT();AUDIO_MUTE_HIGH();}
#else
//	AUDIO_MUTE PIN--------GPIO PC5(PIN15)
#define AUDIO_MUTE_GPIO							_B5_
#define AUDIO_MUTE_INIT()						do{JL_PORTC->PU |= AUDIO_MUTE_GPIO; \
                                            	JL_PORTC->PD &= ~AUDIO_MUTE_GPIO; \
                                            	JL_PORTC->HD &= ~AUDIO_MUTE_GPIO;}while(0)
#define AUDIO_MUTE_HIGH()						(JL_PORTC->OUT |= AUDIO_MUTE_GPIO)
#define AUDIO_MUTE_LOW()						(JL_PORTC->OUT &= ~AUDIO_MUTE_GPIO)
#define AUDIO_MUTE_OUT()						(JL_PORTC->DIR &= ~AUDIO_MUTE_GPIO)
#define AUDIO_MUTE_ON()							{AUDIO_MUTE_OUT();AUDIO_MUTE_LOW();}
#define AUDIO_MUTE_OFF()						{AUDIO_MUTE_OUT();AUDIO_MUTE_HIGH();}
#endif
...
/*----------------------------------------------------------------------------------------------------------------*/
//	ACC_POW1 PIN26--------GPIO PA11
/*----------------------------------------------------------------------------------------------------------------*/
#define ACC_POW1_GPIO							_B10_

#define ACC_POW1_INIT()							do{JL_PORTA->PU |= ACC_POW1_GPIO; \
                                                JL_PORTA->PD &= ~ACC_POW1_GPIO; \
                                                JL_PORTA->HD &= ~ACC_POW1_GPIO;}while(0)
#define ACC_POW1_HIGH()							(JL_PORTA->OUT |= ACC_POW1_GPIO)
#define ACC_POW1_LOW()							(JL_PORTA->OUT &= ~ACC_POW1_GPIO)
#define ACC_POW1_OUT()							(JL_PORTA->DIR &= ~ACC_POW1_GPIO)
#define ACC_POW1_IN()							(JL_PORTA->DIR |= ACC_POW1_GPIO)
#define ACC_POW1_ON()     						{ACC_POW1_OUT(); ACC_POW1_HIGH();}
#define ACC_POW1_OFF()     						{ACC_POW1_OUT(); ACC_POW1_LOW();}
#endif
...
//	USB_PWR PIN--------GPIO PC3(PIN17)
#define USB_PWR_GPIO						_B3_

#define USB_PWR_INIT()						do{JL_PORTC->PU |= USB_PWR_GPIO; \
                                            JL_PORTC->PD &= ~USB_PWR_GPIO; \
                                            JL_PORTC->HD &= ~USB_PWR_GPIO;}while(0)
#define USB_PWR_HIGH()						(JL_PORTC->OUT |= USB_PWR_GPIO)
#define USB_PWR_LOW()						(JL_PORTC->OUT &= ~USB_PWR_GPIO)
#define USB_PWR_OUT()						(JL_PORTC->DIR &= ~USB_PWR_GPIO)
#define USB_PWR_IN()						(JL_PORTC->DIR |= USB_PWR_GPIO)
#define USB_PWR_GET()						(JL_PORTC->IN & USB_PWR_GPIO)
#define USB_PWR_H()     					{USB_PWR_OUT();USB_PWR_HIGH();}
#define USB_PWR_L()     					{USB_PWR_OUT();USB_PWR_LOW();}
#endif


#if defined(_SUPPORT_USB_DET)
//	USB DET CHARGE --------GPIO PA9(PIN27)
#define ADC_USB_CHRG_PIN					AD_KEY_PA9
#endif
