...
#if defined(_FY7000H_RADIO_I2C_)
//	I2C_SCL PIN--------GPIO PC1(PIN19)
#define I2C_SCL_GPIO						_B1_
...
//	I2C_SCL PIN--------GPIO PC2(PIN18)
#define I2C_SDA_GPIO						_B2_
...
#else
//	I2C_SCL PIN--------GPIO PA14(PIN19)
#define I2C_SCL_GPIO						_B14_

#if defined(_DISABLE_RADIO_I2C_PULL_)
...
/*----------PIN19(C1)-REG-----------------------------------------------------------------------------------------------------*/
#if defined(_FY7000F_PANEL_PIN_)
#define SYS_RED_GPIO							_B2_
#else
...
#define RCA_MUTE_GPIO						_B30_
#define RCA_MUTE_INIT()						do{JL_PORTA->PU &= ~RCA_MUTE_GPIO; \
                                           	JL_PORTA->PD &= ~RCA_MUTE_GPIO;}while(0)
#define RCA_MUTE_OUT()						(JL_PORTA->DIR &= ~RCA_MUTE_GPIO)
#define RCA_MUTE_HIGH()						(JL_PORTA->OUT |= RCA_MUTE_GPIO)
#define RCA_MUTE_LOW()						(JL_PORTA->OUT &= ~RCA_MUTE_GPIO)
//#define RCA_MUTE_OFF()						{RCA_MUTE_OUT();RCA_MUTE_LOW();}
#define RCA_MUTE_ON()						{RCA_MUTE_OUT();RCA_MUTE_HIGH();}

#if defined(_DSP_RCA_MUTE_)
#define DSP_RCA_MUTE_GPIO					PORTR3
#define DSP_RCA_MUTE_INIT()					do{PORTR_PU(DSP_RCA_MUTE_GPIO, 0);\
                                            PORTR_PD(DSP_RCA_MUTE_GPIO, 0);}while(0)
#define DSP_RCA_MUTE_OUT()					(PORTR_DIR(DSP_RCA_MUTE_GPIO, 0))
#define DSP_RCA_MUTE_HIGH()					(PORTR_OUT(DSP_RCA_MUTE_GPIO, 1))
#define DSP_RCA_MUTE_LOW()					(PORTR_OUT(DSP_RCA_MUTE_GPIO, 0))
#define DSP_RCA_MUTE_OFF()					{DSP_RCA_MUTE_OUT();DSP_RCA_MUTE_LOW();}
#define DSP_RCA_MUTE_ON()					{DSP_RCA_MUTE_OUT();DSP_RCA_MUTE_HIGH();}
#define RCA_MUTE_OFF()						{DSP_RCA_MUTE_OUT();DSP_RCA_MUTE_LOW();}
#endif
...
/*-----------PIN17(C3)---------------------------------------------------------------------------------------------------*/
#define DSP_RESET_GPIO							_B3_

#define DSP_RESET_INIT()						do{JL_PORTC->PU |= DSP_RESET_GPIO; \
                                                JL_PORTC->PD &= ~DSP_RESET_GPIO; \
                                                JL_PORTC->HD |= DSP_RESET_GPIO;}while(0)
#define DSP_RESET_HIGH()						(JL_PORTC->OUT |= DSP_RESET_GPIO)
#define DSP_RESET_LOW()							(JL_PORTC->OUT &= ~DSP_RESET_GPIO)
#define DSP_RESET_OUT()							(JL_PORTC->DIR &= ~DSP_RESET_GPIO)
#define DSP_RESET_IN()							(JL_PORTC->DIR |= DSP_RESET_GPIO)
#define DSP_RESET_ON()     						{DSP_RESET_OUT(); DSP_RESET_HIGH();}
#define DSP_RESET_OFF()     					{DSP_RESET_OUT(); DSP_RESET_LOW();}
...
/*----------PIN26(A10)------------------------------------------------------------------------------------------------------*/
#define SYS_30P60_LIGHT_GPIO					_B10_

#define SYS_30P60_LIGHT_INIT()					do{JL_PORTA->PU |= SYS_30P60_LIGHT_GPIO; \
                                                   JL_PORTA->PD &= ~SYS_30P60_LIGHT_GPIO; \
                                                   JL_PORTA->HD |= SYS_30P60_LIGHT_GPIO;}while(0)
#define SYS_30P60_LIGHT_HIGH()					(JL_PORTA->OUT |= SYS_30P60_LIGHT_GPIO)
#define SYS_30P60_LIGHT_LOW()					(JL_PORTA->OUT &= ~SYS_30P60_LIGHT_GPIO)
#define SYS_30P60_LIGHT_OUT()					(JL_PORTA->DIR &= ~SYS_30P60_LIGHT_GPIO)
#define SYS_30P60_LIGHT_IN()					(JL_PORTA->DIR |= SYS_30P60_LIGHT_GPIO)
#define SYS_30P60_LIGHT_H()     				{SYS_30P60_LIGHT_OUT(); SYS_30P60_LIGHT_HIGH();}
#define SYS_30P60_LIGHT_L()     				{SYS_30P60_LIGHT_OUT(); SYS_30P60_LIGHT_LOW();}
