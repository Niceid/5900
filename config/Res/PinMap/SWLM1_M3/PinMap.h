...
#define LATCH_CLK_GPIO						_B14_
#define LATCH_CLK_INIT()						do{JL_PORTA->PU |= LATCH_CLK_GPIO; \
                                            JL_PORTA->PD &= ~LATCH_CLK_GPIO; \
                                          JL_PORTA->HD &= ~LATCH_CLK_GPIO;}while(0)
#define LATCH_CLK_HIGH()						(JL_PORTA->OUT |= LATCH_CLK_GPIO)
#define LATCH_CLK_LOW()						(JL_PORTA->OUT &= ~LATCH_CLK_GPIO)
#define LATCH_CLK_OUT()						(JL_PORTA->DIR &= ~LATCH_CLK_GPIO)
#define LATCH_CLK_IN()						(JL_PORTA->DIR |= LATCH_CLK_GPIO)
#define LATCH_CLK_H()     					{LATCH_CLK_OUT();LATCH_CLK_HIGH();}
#define LATCH_CLK_L()     					{LATCH_CLK_OUT();LATCH_CLK_LOW();}

#define LATCH_SCLK_GPIO						_B4_
#define LATCH_SCLK_INIT()						do{JL_PORTC->PU |= LATCH_SCLK_GPIO; \
                                            JL_PORTC->PD &= ~LATCH_SCLK_GPIO; \
                                            JL_PORTC->HD &= ~LATCH_SCLK_GPIO;}while(0)
#define LATCH_SCLK_HIGH()						(JL_PORTC->OUT |= LATCH_SCLK_GPIO)
#define LATCH_SCLK_LOW()						(JL_PORTC->OUT &= ~LATCH_SCLK_GPIO)
#define LATCH_SCLK_OUT()						(JL_PORTC->DIR &= ~LATCH_SCLK_GPIO)
#define LATCH_SCLK_IN()						(JL_PORTC->DIR |= LATCH_SCLK_GPIO)
#define LATCH_SCLK_H()     					{LATCH_SCLK_OUT();LATCH_SCLK_HIGH();}
#define LATCH_SCLK_L()     					{LATCH_SCLK_OUT();LATCH_SCLK_LOW();}

#define LATCH_DATA_GPIO						_B15_
#define LATCH_DATA_INIT()						do{JL_PORTA->PU |= LATCH_DATA_GPIO; \
                                            JL_PORTA->PD &= ~LATCH_DATA_GPIO; \
                                            JL_PORTA->HD &= ~LATCH_DATA_GPIO;}while(0)
#define LATCH_DATA_HIGH()						(JL_PORTA->OUT |= LATCH_DATA_GPIO)
#define LATCH_DATA_LOW()						(JL_PORTA->OUT &= ~LATCH_DATA_GPIO)
#define LATCH_DATA_OUT()						(JL_PORTA->DIR &= ~LATCH_DATA_GPIO)
#define LATCH_DATA_IN()						(JL_PORTA->DIR |= LATCH_DATA_GPIO)
#define LATCH_DATA_H()     					{LATCH_DATA_OUT();LATCH_DATA_HIGH();}
#define LATCH_DATA_L()     					{LATCH_DATA_OUT();LATCH_DATA_LOW();}
...
//	SEG5--------GPIO PA10(PIN26)=====================================================
#define SEG5_GPIO							_B10_
...
#define ADC_VBAR_PIN							AD_KEY_PB12
#endif
