...
/*-----------PIN5(PORTR1)-GREEN----------------------------------------------------------------------------------------------------*/
#define SYS_GREEN_GPIO							PORTR1

#define SYS_GREEN_INIT()						do{PORTR_PU(SYS_GREEN_GPIO, 1);\
                                                   PORTR_PD(SYS_GREEN_GPIO, 0);\
												   PORTR_HD(SYS_GREEN_GPIO, 1);}while(0)
#define SYS_GREEN_HIGH()						(PORTR_OUT(SYS_GREEN_GPIO, 1))
#define SYS_GREEN_LOW()							(PORTR_OUT(SYS_GREEN_GPIO, 0))
#define SYS_GREEN_OUT()							(PORTR_DIR(SYS_GREEN_GPIO, 0))
...
/*----------------------------------------------------------------------------------------------------------------*/
#if defined(_NEW_DVD_PIN_)
#define DISC_RESET_GPIO							_B3_  //跟收音复位共用

#define DISC_RESET_INIT()						do{JL_PORTA->PU |= DISC_RESET_GPIO; \
                                          		   JL_PORTA->PD &= ~DISC_RESET_GPIO; \
                                        		   JL_PORTA->HD &= ~DISC_RESET_GPIO;}while(0)
#define DISC_RESET_HIGH()						(JL_PORTA->OUT |= DISC_RESET_GPIO)
#define DISC_RESET_LOW()						(JL_PORTA->OUT &= ~DISC_RESET_GPIO)
#define DISC_RESET_OUT()						(JL_PORTA->DIR &= ~DISC_RESET_GPIO)
#define DISC_RESET_IN()							(JL_PORTA->DIR |= DISC_RESET_GPIO)
