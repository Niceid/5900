...
#define I2C_SDA_L()     						{I2C_SDA_LOW(); I2C_SDA_OUT();}

/*----------------------------------------------------------------------------------------------------------------*/
//	I2C_SCL PIN--------GPIO A2(PIN30)
/*----------------------------------------------------------------------------------------------------------------*/
...
#define I2C_SCL_L()     						{I2C_SCL_LOW(); I2C_SCL_OUT();}
...
#define AUDIO_MUTE_IN()							(JL_PORTA->DIR |= AUDIO_MUTE_GPIO)
#define AUDIO_MUTE_ON()							{AUDIO_MUTE_OUT();AUDIO_MUTE_HIGH();}
#define AUDIO_MUTE_OFF()						{AUDIO_MUTE_OUT();AUDIO_MUTE_LOW();}
...
#define SYS_POW_IN()							(JL_PORTA->DIR |= SYS_POW_GPIO)
#define SYS_POW_ON()     						{SYS_POW_OUT(); SYS_POW_HIGH();}
#define SYS_POW_OFF()     						{SYS_POW_OUT(); SYS_POW_LOW();}
...
/*----------------------------------------------------------------------------------------------------------------*/
//	ENCODE--------GPIO PR1(PIN5)
/*----------------------------------------------------------------------------------------------------------------*/
#if defined(_SUPPORT_VR_)
#define ADC_ENCODE_PIN							AD_KEY_PR1
#endif

/*----------------------------------------------------------------------------------------------------------------*/
//	ACC PIN--------GPIO PR3(PIN7)
/*----------------------------------------------------------------------------------------------------------------*/
//#define ADC_ACC_PIN							AD_KEY_PR3
