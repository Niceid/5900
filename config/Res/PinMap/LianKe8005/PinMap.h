...
//	DTH PIN--------GPIO C2(PIN23)
#if defined(_SUPPORT_DTH_)

#define DTH_GPIO								_B2_
...
/*----------------------------------------------------------------------------------------------------------------*/
//	CHARGE PIN31--------GPIO PA13
/*----------------------------------------------------------------------------------------------------------------*/

#define SYS_CHARGE_GPIO							_B13_

#define SYS_CHARGE_INIT()						do{JL_PORTA->PU |= SYS_CHARGE_GPIO; \
												JL_PORTA->PD &= ~SYS_CHARGE_GPIO; \
												JL_PORTA->HD |= SYS_CHARGE_GPIO;}while(0)
#define SYS_CHARGE_HIGH()						(JL_PORTA->OUT |= SYS_CHARGE_GPIO)
#define SYS_CHARGE_LOW()						(JL_PORTA->OUT &= ~SYS_CHARGE_GPIO)
#define SYS_CHARGE_OUT()						(JL_PORTA->DIR &= ~SYS_CHARGE_GPIO)
#define SYS_CHARGE_IN()							(JL_PORTA->DIR |= SYS_CHARGE_GPIO)
...
/*-----------PIN33(A11)-----------------------------------------------------------------------------------------------------*/
#define E2PROM_I2C_SDA_GPIO						_B11_

#define E2PROM_I2C_SDA_INIT()					do{JL_PORTA->PU |= E2PROM_I2C_SDA_GPIO; \
                                                   JL_PORTA->PD &= ~E2PROM_I2C_SDA_GPIO; \
                                                   JL_PORTA->HD |= E2PROM_I2C_SDA_GPIO;}while(0)
#define E2PROM_I2C_SDA_HIGH()					(JL_PORTA->OUT |= E2PROM_I2C_SDA_GPIO)
#define E2PROM_I2C_SDA_LOW()					(JL_PORTA->OUT &= ~E2PROM_I2C_SDA_GPIO)
#define E2PROM_I2C_SDA_OUT()					(JL_PORTA->DIR &= ~E2PROM_I2C_SDA_GPIO)
#define E2PROM_I2C_SDA_IN()						(JL_PORTA->DIR |= E2PROM_I2C_SDA_GPIO)
#define E2PROM_I2C_SDA_GET()					(JL_PORTA->IN & E2PROM_I2C_SDA_GPIO)
#define E2PROM_I2C_SDA_H()     					E2PROM_I2C_SDA_IN()
#define E2PROM_I2C_SDA_L()     					{E2PROM_I2C_SDA_OUT();E2PROM_I2C_SDA_LOW(); }

/*-----------PIN32(A12)---------------------------------------------------------------------------------------------------*/
#define E2PROM_I2C_SCL_GPIO						_B12_

#define E2PROM_I2C_SCL_INIT()					do{JL_PORTA->PU |= E2PROM_I2C_SCL_GPIO; \
                                                   JL_PORTA->PD &= ~E2PROM_I2C_SCL_GPIO; \
                                                   JL_PORTA->HD |= E2PROM_I2C_SCL_GPIO;}while(0)
#define E2PROM_I2C_SCL_HIGH()					(JL_PORTA->OUT |= E2PROM_I2C_SCL_GPIO)
#define E2PROM_I2C_SCL_LOW()					(JL_PORTA->OUT &= ~E2PROM_I2C_SCL_GPIO)
#define E2PROM_I2C_SCL_OUT()					(JL_PORTA->DIR &= ~E2PROM_I2C_SCL_GPIO)
#define E2PROM_I2C_SCL_IN()						(JL_PORTA->DIR |= E2PROM_I2C_SCL_GPIO)
