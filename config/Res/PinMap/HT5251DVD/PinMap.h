...
//	ENCODE--------GPIO PB7(PIN46)
#define ADC_ENCODE2_PIN							AD_KEY_PB7
#endif
...
/*-----------PIN48(B0)---------------------------------------------------------------------------------------------------*/
#define E2PROM_I2C_SCL_GPIO						_B0_
...
/*-----------PIN48(B0)---------------------------------------------------------------------------------------------------*/
#define ILL_DETECT_GPIO							_B0_

#define ILL_DETECT_INIT()						do{JL_PORTB->PU |= ILL_DETECT_GPIO; \
                                               	   JL_PORTB->PD &= ~ILL_DETECT_GPIO; \
                                               	   JL_PORTB->HD |= ILL_DETECT_GPIO;}while(0)
#define ILL_DETECT_HIGH()						(JL_PORTB->OUT |= ILL_DETECT_GPIO)
#define ILL_DETECT_LOW()						(JL_PORTB->OUT &= ~ILL_DETECT_GPIO)
#define ILL_DETECT_OUT()						(JL_PORTB->DIR &= ~ILL_DETECT_GPIO)
#define ILL_DETECT_IN()							(JL_PORTB->DIR |= ILL_DETECT_GPIO)
#define ILL_DETECT_GET()						(JL_PORTB->IN & ILL_DETECT_GPIO)
#define ILL_DETECT_CHECK()						(ILL_DETECT_GET() ? 0 : 1)

/*-----------PIN47B1)-----------------------------------------------------------------------------------------------------*/
#define ILL_LIGHT_GPIO							_B1_

#define ILL_LIGHT_INIT()						do{JL_PORTB->PU |= ILL_LIGHT_GPIO; \
                                                   JL_PORTB->PD &= ~ILL_LIGHT_GPIO; \
                                                   JL_PORTB->HD |= ILL_LIGHT_GPIO;}while(0)
#define ILL_LIGHT_HIGH()						(JL_PORTB->OUT |= ILL_LIGHT_GPIO)
#define ILL_LIGHT_LOW()							(JL_PORTB->OUT &= ~ILL_LIGHT_GPIO)
#define ILL_LIGHT_OUT()							(JL_PORTB->DIR &= ~ILL_LIGHT_GPIO)
#define ILL_LIGHT_IN()							(JL_PORTB->DIR |= ILL_LIGHT_GPIO)
