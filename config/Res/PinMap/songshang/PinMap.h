...
//	SEG8--------GPIO PC0(PIN22)
#define SEG7_GPIO							_B0_
#define SEG7_OFF()							do{JL_PORTC->OUT &= ~SEG7_GPIO;\
											JL_PORTC->DIR |=  SEG7_GPIO;\
											JL_PORTC->PU &= ~SEG7_GPIO; \
                                          	JL_PORTC->PD &= ~SEG7_GPIO; \
                                       		JL_PORTC->HD &= ~SEG7_GPIO;}while(0)

#define SEG7_ON()							do{JL_PORTC->OUT &= ~SEG7_GPIO; \
                                              JL_PORTC->DIR &= ~SEG7_GPIO;}while(0)

//	SEG5--------GPIO PA11(PIN25)
#define SEG4_GPIO							_B11_
...
//  AUX PIN--------GPIO PA2(PIN30)
#define AUX_DET_GPIO						_B2_
...
#define AUX_DET_CHECK()						0//(AUX_DET_GET() ? 0 : 1)
...
/*----------------------------------------------------------------------------------------------------------------*/
//	RADIO_RESET PIN--------GPIO A1(PIN31)¸´ÓÃMIC
/*----------------------------------------------------------------------------------------------------------------*/
