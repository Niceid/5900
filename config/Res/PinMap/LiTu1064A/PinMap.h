...
/*----------------------------------------------------------------------------------------------------------------*/
//	ACC_POW PIN26--------GPIO PA10
/*----------------------------------------------------------------------------------------------------------------*/
#define ACC_POW_GPIO							_B10_

#define ACC_POW_INIT()							do{JL_PORTA->PU &= ~ACC_POW_GPIO; \
                                                JL_PORTA->PD &= ~ACC_POW_GPIO; \
                                                JL_PORTA->HD &= ~ACC_POW_GPIO;}while(0)
#define ACC_POW_HIGH()							(JL_PORTA->OUT |= ACC_POW_GPIO)
#define ACC_POW_LOW()							(JL_PORTA->OUT &= ~ACC_POW_GPIO)
#define ACC_POW_OUT()							(JL_PORTA->DIR &= ~ACC_POW_GPIO)
#define ACC_POW_IN()							(JL_PORTA->DIR |= ACC_POW_GPIO)
