...
#define AUDIO_CONTROL_SPK_GPIO						_B5_

#define AUDIO_CONTROL_SPK_INIT()						do{JL_PORTC->PU |= AUDIO_CONTROL_SPK_GPIO; \
                                                   JL_PORTC->PD &= ~AUDIO_CONTROL_SPK_GPIO; \
                                                   JL_PORTC->HD |= AUDIO_CONTROL_SPK_GPIO;}while(0)

#define AUDIO_CONTROL_SPK_HIGH()						(JL_PORTC->OUT |= AUDIO_CONTROL_SPK_GPIO)
#define AUDIO_CONTROL_SPK_LOW()						(JL_PORTC->OUT &= ~AUDIO_CONTROL_SPK_GPIO)
#define AUDIO_CONTROL_SPK_OUT()						(JL_PORTC->DIR &= ~AUDIO_CONTROL_SPK_GPIO)
#define AUDIO_CONTROL_SPK_OFF()						{AUDIO_CONTROL_SPK_OUT();AUDIO_CONTROL_SPK_HIGH();}
#define AUDIO_CONTROL_SPK_ON()						{AUDIO_CONTROL_SPK_OUT();AUDIO_CONTROL_SPK_LOW();}
#endif
#define AUDIO_MUTE_GPIO							PORTR0
#define AUDIO_MUTE_INIT()						do{PORTR_PU(AUDIO_MUTE_GPIO, 0);\
                                                   PORTR_PD(AUDIO_MUTE_GPIO, 0);AUDIO_CONTROL_SPK_INIT();}while(0)
...
#define AUDIO_MUTE_ON()							{AUDIO_MUTE_OUT();AUDIO_MUTE_HIGH();AUDIO_CONTROL_SPK_OUT();AUDIO_CONTROL_SPK_HIGH();}
#define AUDIO_MUTE_OFF()						{AUDIO_MUTE_OUT();AUDIO_MUTE_LOW();AUDIO_CONTROL_SPK_OUT();AUDIO_CONTROL_SPK_LOW();}
