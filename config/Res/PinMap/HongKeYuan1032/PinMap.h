...
#define ADC_ENCODE2_PIN							AD_KEY_PB12
#endif
...
//	AUDIO_MUTE PIN--------GPIO PC1(PIN19)
#define AUDIO_MUTE_GPIO							_B1_
#define AUDIO_MUTE_INIT()						do{JL_PORTC->PU &= ~AUDIO_MUTE_GPIO; \
                                           		 JL_PORTC->PD &= ~AUDIO_MUTE_GPIO;}while(0)
...
//	I2C_SDA PIN--------GPIO PC5(PINB15)
#define I2C_SDA_GPIO						_B5_
...
//	I2C_SCL PIN--------GPIO PC4(PINB16)
#define I2C_SCL_GPIO						_B4_
...
//	I2C_SDA PIN--------GPIO PC3(PINB17)
#define I2C_SDA_GPIO1						_B3_
...
//	I2C_SCL PIN--------GPIO PC2(PINB18)
#define I2C_SCL_GPIO1						_B2_
