...
#define SYS_BACKLIGHT_GPIO					_B11_

#define SYS_BACKLIGHT_INIT()					do{JL_PORTA->PU |= SYS_BACKLIGHT_GPIO; \
                                                  JL_PORTA->PD &= ~SYS_BACKLIGHT_GPIO; \
                                                  JL_PORTA->HD |= SYS_BACKLIGHT_GPIO;}while(0)
#define SYS_BACKLIGHT_HIGH()					(JL_PORTA->OUT |= SYS_BACKLIGHT_GPIO)
#define SYS_BACKLIGHT_LOW()						(JL_PORTA->OUT &= ~SYS_BACKLIGHT_GPIO)
#define SYS_BACKLIGHT_OUT()						(JL_PORTA->DIR &= ~SYS_BACKLIGHT_GPIO)
#define SYS_BACKLIGHT_IN()						(JL_PORTA->DIR |= SYS_BACKLIGHT_GPIO)
#define SYS_BACKLIGHT_ON()     					{SYS_BACKLIGHT_OUT(); SYS_BACKLIGHT_HIGH();}
#define SYS_BACKLIGHT_OFF()     				{SYS_BACKLIGHT_OUT(); SYS_BACKLIGHT_LOW();}
#endif
