...
/*-----------PIN16(PC4)-----------------------------------------------------------------------------------------------------*/
#define AKIN_OUTPUT_GPIO							_B4_

#define AKIN_OUTPUT_INIT()						do{JL_PORTC->PU |= AKIN_OUTPUT_GPIO; \
                                                   JL_PORTC->PD &= ~AKIN_OUTPUT_GPIO; \
                                                   JL_PORTC->HD |= AKIN_OUTPUT_GPIO;}while(0)
#define AKIN_OUTPUT_HIGH()						 (JL_PORTC->OUT |= AKIN_OUTPUT_GPIO)
#define AKIN_OUTPUT_LOW()					     (JL_PORTC->OUT &= ~AKIN_OUTPUT_GPIO)
#define AKIN_OUTPUT_OUT()						 (JL_PORTC->DIR &= ~AKIN_OUTPUT_GPIO)
#define AKIN_OUTPUT_IN()						 (JL_PORTC->DIR |= AKIN_OUTPUT_GPIO)
#define AKIN_OUTPUT_ON()     					 {AKIN_OUTPUT_OUT();AKIN_OUTPUT_LOW();}
#define AKIN_OUTPUT_OFF()     					 {AKIN_OUTPUT_OUT();AKIN_OUTPUT_HIGH();}
#endif
