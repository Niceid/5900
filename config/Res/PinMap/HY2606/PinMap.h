...
#define SYS_CHARGE_GPIO							_B5_

#define SYS_CHARGE_INIT()						do{JL_PORTC->PU |= SYS_CHARGE_GPIO; \
													   JL_PORTC->PD &= ~SYS_CHARGE_GPIO; \
													   JL_PORTC->HD |= SYS_CHARGE_GPIO;}while(0)
#define SYS_CHARGE_HIGH()						(JL_PORTC->OUT |= SYS_CHARGE_GPIO)
#define SYS_CHARGE_LOW()						(JL_PORTC->OUT &= ~SYS_CHARGE_GPIO)
#define SYS_CHARGE_OUT()						(JL_PORTC->DIR &= ~SYS_CHARGE_GPIO)
#define SYS_CHARGE_IN()							(JL_PORTC->DIR |= SYS_CHARGE_GPIO)
