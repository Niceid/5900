...
//	ILL_LIGHT_DET PIN--------GPIO A0(PIN44)//
#define ILL_LIGHT_DET_GPIO					_B0_
...
//	KB_LIGHT PIN--------GPIO A13(PIN31) 小灯功能 控制开关
#define KB_LIGHT_GPIO						_B13_
...
//	LED PIN--------GPIO A11(PIN33)	面板LED灯开关控制脚
#define ACC_POWER_GPIO							_B11_

#define ACC_POWER_INIT()						do{JL_PORTA->PU |= ACC_POWER_GPIO; \
                                                   JL_PORTA->PD &= ~ACC_POWER_GPIO; \
                                                   JL_PORTA->HD |= ACC_POWER_GPIO;}while(0)
#define ACC_POWER_HIGH()						(JL_PORTA->OUT |= ACC_POWER_GPIO)
#define ACC_POWER_LOW()							(JL_PORTA->OUT &= ~ACC_POWER_GPIO)
#define ACC_POWER_OUT()							(JL_PORTA->DIR &= ~ACC_POWER_GPIO)
#define ACC_POWER_IN()							(JL_PORTA->DIR |= ACC_POWER_GPIO)
...
//	LED PIN--------GPIO A12(PIN32)	面板LED灯开关控制脚
#define POWOR_LED_GPIO					  _B12_

#define POWOR_LED_INIT()				do{JL_PORTA->PU &= ~POWOR_LED_GPIO; \
                                           JL_PORTA->PD &= ~POWOR_LED_GPIO; \
                                           JL_PORTA->HD &= ~POWOR_LED_GPIO;}while(0)
#define POWOR_LED_HIGH()				(JL_PORTA->OUT |= POWOR_LED_GPIO)
#define POWOR_LED_LOW()					(JL_PORTA->OUT &= ~POWOR_LED_GPIO)
#define POWOR_LED_OUT()					(JL_PORTA->DIR &= ~POWOR_LED_GPIO)
#define POWOR_LED_IN()				    (JL_PORTA->DIR |= POWOR_LED_GPIO) 

#define POWOR_LED_ON()     				{POWOR_LED_OUT();POWOR_LED_HIGH();}
#define POWOR_LED_OFF()     			{POWOR_LED_OUT();POWOR_LED_LOW();}
