...
//	I2C_SCL PIN--------GPIO PA11(PIN25)
#define I2C_SCL_GPIO1						_B11_
#define I2C_SCL_INIT1()						do{JL_PORTA->PU |= I2C_SCL_GPIO1; \
                                            JL_PORTA->PD &= ~I2C_SCL_GPIO1; \
                                            JL_PORTA->HD &= ~I2C_SCL_GPIO1;}while(0)
#define I2C_SCL_HIGH1()						(JL_PORTA->OUT |= I2C_SCL_GPIO1)
#define I2C_SCL_LOW1()						(JL_PORTA->OUT &= ~I2C_SCL_GPIO1)
#define I2C_SCL_OUT1()						(JL_PORTA->DIR &= ~I2C_SCL_GPIO1)
#define I2C_SCL_IN1()						(JL_PORTA->DIR |= I2C_SCL_GPIO1)
#define I2C_SCL_H1()     					{I2C_SCL_OUT1();I2C_SCL_HIGH1();}
#define I2C_SCL_L1()     					{I2C_SCL_OUT1();I2C_SCL_LOW1();}

//	I2C_SDA PIN--------GPIO PA10(PIN26)
#define I2C_SDA_GPIO1						_B10_

#define I2C_SDA_INIT1()						do{JL_PORTA->PU |= I2C_SDA_GPIO1; \
                                            JL_PORTA->PD &= ~I2C_SDA_GPIO1; \
                                            JL_PORTA->HD &= ~I2C_SDA_GPIO1;}while(0)
#define I2C_SDA_HIGH1()						(JL_PORTA->OUT |= I2C_SDA_GPIO1)
#define I2C_SDA_LOW1()						(JL_PORTA->OUT &= ~I2C_SDA_GPIO1)
#define I2C_SDA_OUT1()						(JL_PORTA->DIR &= ~I2C_SDA_GPIO1)
#define I2C_SDA_IN1()						(JL_PORTA->DIR |= I2C_SDA_GPIO1)
#define I2C_SDA_GET1()						(JL_PORTA->IN & I2C_SDA_GPIO1)
...
/*-------------------------------------------------------------------------------------------------------------*/
#if defined(_SUPPORT_MIC_OK_)// PIN29(PA3)

#define MIC_GPIO								_B3_
