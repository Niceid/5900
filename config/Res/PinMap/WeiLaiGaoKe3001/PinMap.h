...
//	DAB_RX PIN1--------GPIO PA2(PIN30)
#define DAB_RX_GPIO							_B2_
#define DAB_RX_INIT()						do{JL_PORTA->PU |= DAB_RX_GPIO; \
                                            JL_PORTA->PD &= ~DAB_RX_GPIO; \
                                            JL_PORTA->HD &= ~DAB_RX_GPIO;}while(0)
#define DAB_RX_OUT()						(JL_PORTA->DIR &= ~DAB_RX_GPIO)
#define DAB_RX_IN()							(JL_PORTA->DIR |= DAB_RX_GPIO)
#define DAB_RX_HIGH()						(JL_PORTA->OUT |= DAB_RX_GPIO)
#define DAB_RX_LOW()						(JL_PORTA->OUT &= ~DAB_RX_GPIO)

//	DAB_TX PIN2--------GPIO PA1(PIN31)
#define DAB_TX_GPIO							_B1_
#define DAB_TX_INIT()						do{JL_PORTA->PU |= DAB_TX_GPIO; \
                                            JL_PORTA->PD &= ~DAB_TX_GPIO; \
                                            JL_PORTA->HD &= ~DAB_TX_GPIO;}while(0)
#define DAB_TX_OUT()						(JL_PORTA->DIR &= ~DAB_TX_GPIO)
#define DAB_TX_IN()							(JL_PORTA->DIR |= DAB_TX_GPIO)
#define DAB_TX_HIGH()						(JL_PORTA->OUT |= DAB_TX_GPIO)
#define DAB_TX_LOW()						(JL_PORTA->OUT &= ~DAB_TX_GPIO)
...
#define BT_TEL_MUTE_GPIO						_B11_

#define BT_TEL_MUTE_INIT()						do{JL_PORTB->PU |= BT_TEL_MUTE_GPIO; \
                                                JL_PORTB->PD &= ~BT_TEL_MUTE_GPIO; \
                                                JL_PORTB->HD &= ~BT_TEL_MUTE_GPIO;}while(0)
#define BT_TEL_MUTE_HIGH()						(JL_PORTB->OUT |= BT_TEL_MUTE_GPIO)
#define BT_TEL_MUTE_LOW()						(JL_PORTB->OUT &= ~BT_TEL_MUTE_GPIO)
#define BT_TEL_MUTE_OUT()						(JL_PORTB->DIR &= ~BT_TEL_MUTE_GPIO)
#define BT_TEL_MUTE_IN()						(JL_PORTB->DIR |= BT_TEL_MUTE_GPIO)

#define BT_TEL_MUTE_GET()						(JL_PORTB->IN & BT_TEL_MUTE_GPIO)
#define BT_TEL_MUTE_CHECK()						(BT_TEL_MUTE_GET() ? 0 : 1)
#endif
...
/*----------PIN18(C2)-REG-----------------------------------------------------------------------------------------------------*/
#define SYS_BEEP_GPIO							_B2_

#define SYS_BEEP_INIT()							do{JL_PORTC->PU |= SYS_BEEP_GPIO; \
                                                   JL_PORTC->PD &= ~SYS_BEEP_GPIO; \
                                                   JL_PORTC->HD |= SYS_BEEP_GPIO;}while(0)
#define SYS_BEEP_HIGH()							(JL_PORTC->OUT |= SYS_BEEP_GPIO)
#define SYS_BEEP_LOW()							(JL_PORTC->OUT &= ~SYS_BEEP_GPIO)
#define SYS_BEEP_OUT()							(JL_PORTC->DIR &= ~SYS_BEEP_GPIO)
#define SYS_BEEP_IN()							(JL_PORTC->DIR |= SYS_BEEP_GPIO)
