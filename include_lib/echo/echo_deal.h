...
void res_set_reverb_parm_2(void *reverb_obj);//??o?	void reg_ef_reverb_parm2(EF_REVERB_PARM2 * parm) ê1ó?

//deep_val:0-1024,é??è      vol_val:0-128￡????è
...
void howlingsuppress_sw(u8 on);//D￥?Dò????a1?
void howlingsuppress_suppression_val(u8 val);//0-250: D￥?Dò???3ì?è￡??μ??′óò???D§1???′ó￡?μ??áó°?ìéùò??μ?×￡??¨òé?μ120?￡
