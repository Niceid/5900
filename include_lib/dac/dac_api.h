...
#if defined(TD_ADD_FM_IN_MCU)//FM音频信号直接进解码  选择对应的引脚
#define FM_IIC_CHANNEL     DAC_AMUX2
#elif defined(TD_ADD_FM_IN_AMPLIFIER)//FM音频信号直接进功放
#define FM_IIC_CHANNEL     0xff
#elif defined(JYL_FM_IN_MCU)//FM音频信号直接进解码  选择对应的引脚
#define FM_IIC_CHANNEL     DAC_AMUX1
#elif defined(_ENABLE_AUX_CHANNEL_)
#define FM_IIC_CHANNEL     DAC_AMUX1
#elif defined(_ENABLE_FM_CHANNEL_)
#define FM_IIC_CHANNEL     DAC_AMUX0
...
#if defined (TD_ADD_AUX_IN_MCU)//aux音频信号直接进解码  选择对应的引脚
#define LINEIN_CHANNEL     DAC_AMUX0
#elif defined(_DECODER_AUDIO_CONTROL_)
